...
import org.forgerock.openam.auditors.SMSAuditorImpl;
    ...
    public static class TestGuiceModule extends AbstractModule {
        ...
        protected void configure() {
            ...
            bind(ConfigAuditorFactory.class).toInstance(new ConfigAuditorFactory() {
                @Override
                public SMSAuditorImpl create(SSOToken runAs, @Assisted("realm") @Nullable String realm, @Assisted("objectId") String objectId, Map initialState) {
                    return mock(SMSAuditorImpl.class);
                }
            });
