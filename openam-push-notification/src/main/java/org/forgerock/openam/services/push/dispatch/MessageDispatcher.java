...
public class MessageDispatcher {
     ...
     */
    public MessageDispatcher(Cache<MessageId, MessagePromise> dispatch, @Named("frPush") Debug debug,
    ...
    private void storeInCTS(MessagePromise messagePromise, int timeout) throws CoreTokenException {
        Token ctsToken = new Token(messagePromise.getMessageId().toString(), TokenType.PUSH);
