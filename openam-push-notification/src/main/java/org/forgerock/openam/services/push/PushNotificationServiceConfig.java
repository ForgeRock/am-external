...
public final class PushNotificationServiceConfig {
    ...
    private int messageDispatcherDuration;
    ...
    private void setMessageDispatcherDuration(int messageDispatcherDuration) {
     ...
     */
    public int getMessageDispatcherDuration() {
    ...
    public static class Builder {
         ...
         * @return The builder.
         */
        public Builder withMessageDispatcherDuration(int duration) {
