...
import static org.forgerock.openam.services.push.PushNotificationConstants.JWT_RESPONSE_CLAIM_KEY;
...
public class PushMessageChallengeResponsePredicate extends AbstractPredicate {
    ...
    public boolean perform(JsonValue content) {
        ...
        String response = (String) signedJwt.getClaimsSet().getClaim(JWT_RESPONSE_CLAIM_KEY);
