...
@Node.Metadata(outcomeProvider = SocialProviderHandlerNode.SocialAuthOutcomeProvider.class,
        ...
        tags = {"social", "federation", "platform", "deprecated"})
@Deprecated
public class SocialProviderHandlerNode implements Node {
    ...
    public Action process(TreeContext context) throws NodeProcessException {
        ...
        Action action = getAction(context, selectedIdp, idpConfig, client, dataStore);
        if (action != null) {
            return action;
        }
    ...
    /**
     * Get the action that this node should perform. Will return null if there is no applicable action based on the
     * provided parameters.
     *
     * @param context     The tree context.
     * @param selectedIdp The selected identity provider.
     * @param idpConfig   The identity provider config.
     * @param client      The OAuth client.
     * @param dataStore   The datastore.
     * @return The action that should be returned by the node process or null if none are applicable.
     * @throws NodeProcessException if an error occurs trying to determine the action.
     */
    protected Action getAction(TreeContext context, String selectedIdp,
        ...
        return handleCallback(context, selectedIdp, idpConfig, client, dataStore);
    }

    /**
     * If the results of a callback are provided, return the action that should be performed.
     *
     * @param context     The tree context.
     * @param selectedIdp The selected identity provider.
     * @param idpConfig   The identity provider config.
     ...
     * @throws NodeProcessException if an error occurs trying to determine the action.
     */
    protected Action handleCallback(TreeContext context, String selectedIdp, OAuthClientConfig idpConfig,
