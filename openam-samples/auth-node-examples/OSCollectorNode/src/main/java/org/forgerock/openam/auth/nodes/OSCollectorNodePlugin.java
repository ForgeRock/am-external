 ...
 */
public class OSCollectorNodePlugin extends AbstractNodeAmPlugin {
     ...
     */
    @Inject
    public OSCollectorNodePlugin(AnnotatedServiceRegistry serviceRegistry) {
