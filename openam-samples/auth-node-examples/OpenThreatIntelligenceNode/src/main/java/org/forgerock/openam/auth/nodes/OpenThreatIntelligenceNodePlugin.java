 ...
 */
public class OpenThreatIntelligenceNodePlugin extends AbstractNodeAmPlugin {
     ...
     */
    @Inject
    public OpenThreatIntelligenceNodePlugin(AnnotatedServiceRegistry serviceRegistry) {
    ...
    protected Iterable<? extends Class<? extends Node>> getNodes() {
        return asList(
                OpenThreatIntelligenceNode.class
        );
    }
}
