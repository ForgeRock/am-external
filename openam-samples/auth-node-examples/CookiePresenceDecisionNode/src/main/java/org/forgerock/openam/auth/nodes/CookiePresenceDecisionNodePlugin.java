 ...
 */
public class CookiePresenceDecisionNodePlugin extends AbstractNodeAmPlugin {
     ...
     */
    @Inject
    public CookiePresenceDecisionNodePlugin(AnnotatedServiceRegistry serviceRegistry) {
