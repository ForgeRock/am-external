...
This sample client performs a POST with an JWT that it has signed. You can read more about this sample and how it works in the [JWT Bearer Profile](https://backstage.forgerock.com/docs/openam/12/admin-guide/#oauth2-jwt-bearer) chapter of the OpenAM Admin Guide.
