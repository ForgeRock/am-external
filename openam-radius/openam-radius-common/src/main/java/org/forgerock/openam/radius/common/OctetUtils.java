...
public final class OctetUtils {
     ...
     */
    public static byte[] toOctets(AttributeType type, String str) {
     ...
     * @return the on-the-wire byte representation
     */
    public static byte[] toOctets(AttributeType type, int intValue) {
     ...
     */
    public static byte[] toOctets(AttributeType type, int msb, int msb2, int msb3, int msb4) {
        final byte[] octets = new byte[6];
        octets[0] = (byte) type.getTypeCode();
        octets[1] = 6;
     ...
     */
    public static int toIntVal(byte[] octets) {
