...
public class UserPasswordAttribute extends Attribute {
     ...
     */
    private static byte[] toOctets(Authenticator ra, String secret, String password) {
        byte[] bytes;
        try {
     ...
     */
    private static byte[] convert(byte[] value, Direction direction, String secret, Authenticator ra)
            throws IOException {
