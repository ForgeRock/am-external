...
/**
 * Tests for {@link UserPasswordAttribute}.
 */
public class UserPasswordAttributeTest {

    @Test
    void testEncDec() throws IOException {
        ...
        assertThat(pwd).isEqualTo(Rfc2865Examples.password).describedAs("passwords should be recoverable");
    }

    @Test
    void testLongerPwd() throws IOException {
        ...
        assertThat(pwd).isEqualTo("secret").describedAs("passwords should be 'secret'");
    }
     ...
     */
    @Test
    void test15charPwd() throws NoSuchAlgorithmException, IOException {
        ...
        assertThat(pwd).isEqualTo(pwd15).describedAs("15 character password should be the same after decoding.");
    }
     ...
     */
    @Test
    void test16charPwd() throws NoSuchAlgorithmException, IOException {
        ...
        assertThat(pwd2).isEqualTo(pwd).describedAs("16 character password should be the same after decoding.");
    }

    @Test
    void test36charPwd() throws NoSuchAlgorithmException, IOException {
        ...
        final UserPasswordAttribute upa2 = new UserPasswordAttribute(bytes);
        final String pwd2 = upa2.extractPassword(ra, secret);
        assertThat(pwd2).isEqualTo(pwd).describedAs("36 character password should be the same after decoding.");
    }

    @Test
    void testMultiByteCharPwd() throws NoSuchAlgorithmException, IOException {
        ...
        final UserPasswordAttribute upa2 = new UserPasswordAttribute(bytes);
        final String pwd2 = upa2.extractPassword(ra, secret);
        assertThat(pwd2).isEqualTo(pwd).describedAs("multibyte character password should be the same after decoding.");
    }
