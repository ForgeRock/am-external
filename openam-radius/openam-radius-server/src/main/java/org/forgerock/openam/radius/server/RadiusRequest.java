...
public class RadiusRequest {
     ...
     */
    private static final Logger LOG = LoggerFactory.getLogger(RadiusRequest.class);
     ...
     */
    public RadiusRequest(Packet requestPacket, String requestId) {
    ...
    public void setContextHolderKey(String cacheKey) {
        getAuditRequestContext().addTrackingId(cacheKey);
