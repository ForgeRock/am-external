...
public class DroppedRequestHandler implements RejectedExecutionHandler {
     ...
     */
    private static final Logger LOG = LoggerFactory.getLogger(DroppedRequestHandler.class);
    ...
    public void rejectedExecution(Runnable r, ThreadPoolExecutor executor) {
        ...
        LOG.warn("RADIUS thread pool queue full. Dropping packet from " + handler.getClientName());
    }
}
