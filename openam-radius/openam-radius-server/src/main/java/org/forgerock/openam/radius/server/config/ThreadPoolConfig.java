...
public class ThreadPoolConfig {
    ...
    public ThreadPoolConfig(int core, int max, int queueSize, int keepAliveSeconds) {
        if (core < 1) {
            ...
            logger.warn("System configured to used invalid Radius Thread Pool Core size of " + core
        ...
        if (max < this.coreThreads) {
            ...
            logger.warn("System configured to use Radius Server 'Thread Pool Max Size' that is less than 'Thread "
        ...
        if (queueSize < 1 || queueSize > 1000) {
            ...
            logger.warn("System configured to use an invalid Radius Server 'Thread Pool Queue Size' value of '"
        ...
        if (keepAliveSeconds < 1 || keepAliveSeconds > 3600) {
            ...
            logger.warn("System configured to use an invalid Radius Server 'Thread Pool Keep-Alive Seconds' value of"
                    + " '"
                    + keepAliveSeconds
