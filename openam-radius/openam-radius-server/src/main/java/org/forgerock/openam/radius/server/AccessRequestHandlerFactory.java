...
public class AccessRequestHandlerFactory {
     ...
     */
    private static final Logger LOG = LoggerFactory.getLogger(AccessRequestHandlerFactory.class);

    /**
     * Constructor.
     */
    public AccessRequestHandlerFactory() {
        LOG.debug("Constructing AccessRequestHandlerFactory.AccessRequestHandlerFactory()");
    }
    ...
    public AccessRequestHandler getAccessRequestHandler(RadiusRequestContext reqCtx) {
        LOG.debug("Entering RadiusRequestHandler.getAccessRequestHandler()");
        ...
        LOG.debug("Leaving RadiusRequestHandler.getAccessRequestHandler()");
