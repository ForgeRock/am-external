...
public class ContextHolderCache {
    ...
    private static Logger logger = LoggerFactory.getLogger(ContextHolderCache.class);
    ...
    private void updateCacheSize() {
        ...
        if (desiredMaxSize != actualMaxSize) {
            ...
            if (desiredMaxSize > cache.size()) {
                ...
                logger.warn("Shrinking ContextHolderCache in response to change of system setting that determines "
