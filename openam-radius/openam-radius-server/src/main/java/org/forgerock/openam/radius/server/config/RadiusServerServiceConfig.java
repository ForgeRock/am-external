...
public interface RadiusServerServiceConfig
    ...
    interface RadiusClient {
        ...
        /**
         * Returns whether the Radius client requires Message Authenticator attribute.
         *
         * @return whether the Radius client requires Message Authenticator attribute.
         */
        @Attribute(
                order = 1000,
                i18nKey = "message-authenticator-required",
                name = RadiusServerConstants.MESSAGE_AUTHENTICATOR_REQUIRED)
        default boolean isMessageAuthenticatorRequired() {
            return true;
        }
    }
