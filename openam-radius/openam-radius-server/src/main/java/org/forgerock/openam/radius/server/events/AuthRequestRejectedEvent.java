 ...
 * the client.
 */
public class AuthRequestRejectedEvent extends AcceptedRadiusEvent {

    private static final Logger LOG = LoggerFactory.getLogger(AuthRequestRejectedEvent.class);
     ...
     */
    public AuthRequestRejectedEvent(RadiusRequest request, RadiusResponse response, RadiusRequestContext context) {
        super(request, response, context);
        LOG.debug("Constructed AuthRequestRejectedEvent.AuthRequestRejectedEvent()");
    }
