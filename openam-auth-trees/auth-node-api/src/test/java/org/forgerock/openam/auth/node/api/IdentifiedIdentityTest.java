...
public class IdentifiedIdentityTest {
    ...
    public void testToJson() {
        IdentifiedIdentity identifiedIdentity = new IdentifiedIdentity("test_name", "user");
        assertThat(identifiedIdentity.toJson().asMap())
                .containsExactlyInAnyOrderEntriesOf(Map.of("name", "test_name", "type", "user"));
    }
    ...
    public void testFromJson() {
        ...
        assertThat(identifiedIdentity.getIdentityType()).isEqualTo("user");
    }
