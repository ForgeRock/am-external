...
public class IdentifiedIdentity {
     ...
     */
    public IdentifiedIdentity(String username, String identityType) {
    ...
    public JsonValue toJson() {
        return json(object(field(USERNAME_FIELD, username), field(IDENTITY_TYPE_FIELD, identityType)));
    }
    ...
    public static IdentifiedIdentity fromJson(JsonValue json) {
        ...
        String idType = json.get(IDENTITY_TYPE_FIELD).asString();
        return new IdentifiedIdentity(json.get(USERNAME_FIELD).asString(), idType);
    }
