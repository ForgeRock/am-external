 ...
 *
 * <p>A collection that supports order-independent equality, like {@link Set}, but
 ...
 * implementation.
 *
 * <p>Common implementations include {@code ImmutableMultiset}, {@code
 * HashMultiset}, and {@code ConcurrentHashMultiset}.
 *
...
public interface Multiset<E> extends Collection<E> {
     ...
     *
     * <p><b>Note:</b> the utility method {@code Iterables#frequency} generalizes
     ...
     * in {@code c}, see {@code Multisets#removeOccurrences(Multiset, Multiset)}.
     *
     ...
     * {@code c}, and only cares whether or not an element appears at all.
     * If you wish to remove one occurrence in this multiset for every occurrence
     * in {@code c}, see {@code Multisets#retainOccurrences(Multiset, Multiset)}.
     *
     * <p>This method refines {@link Collection#retainAll} to further specify that
     * it <b>may not</b> throw an exception in response to any of {@code elements}
     * being null or of the wrong type.
     *
     * @see com.google.common.collect.Multisets#retainOccurrences(com.google.common.collect.Multiset,
