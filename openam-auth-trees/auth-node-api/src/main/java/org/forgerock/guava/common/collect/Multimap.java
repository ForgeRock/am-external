 ...
 *
 * Portions Copyright 2018-2019 ForgeRock AS.
 */
 ...
 * subinterfaces {@link ListMultimap} and {@link com.google.common.collect.SetMultimap}. These take their
 ...
 *
 * <p>As always, prefer the immutable implementations, {@link com.google.common.collect.ImmutableListMultimap}
 * and {@link com.google.common.collect.ImmutableSetMultimap}. General-purpose
 ...
 * Map} and {@link Collection} types, using the {@link com.google.common.collect.Multimaps#newMultimap
 * Multimaps.newMultimap} family of methods. Finally, another popular way to
 * obtain a multimap is using {@link com.google.common.collect.Multimaps#index Multimaps.index}. See
 * the {@link com.google.common.collect.Multimaps} class for these and other static utilities related
 * to multimaps.
 *
 * <h3>Other Notes</h3>
 *
 ...
 * @deprecated Use {@link com.google.common.collect.Multimap} instead.
 */
@GwtCompatible
@Deprecated
public interface Multimap<K, V> {
     ...
     * {@link com.google.common.collect.SetMultimap} instances with the same key-value mappings are equal,
     * but equality of two {@link ListMultimap} instances depends on the ordering
     * of the values for each key.
     *
     * <p>A non-empty {@link com.google.common.collect.SetMultimap} cannot be equal to a non-empty
     ...
     * example, two {@link com.google.common.collect.SetMultimap} instances with the same key-value
