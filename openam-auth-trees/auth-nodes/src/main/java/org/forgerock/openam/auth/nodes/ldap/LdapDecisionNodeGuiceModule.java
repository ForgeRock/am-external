...
/**
 * Guice Module for configuring bindings for the LDAP decision node.
 */
@AutoService(Module.class)
public class LdapDecisionNodeGuiceModule extends AbstractModule {
    @Override
    protected void configure() {
        Multibinder.newSetBinder(binder(), SecretStoreConfigChangeListener.class).addBinding()
                .to(LdapDecisionNodeSecretStoreConfigChangeListener.class);
    }
}
