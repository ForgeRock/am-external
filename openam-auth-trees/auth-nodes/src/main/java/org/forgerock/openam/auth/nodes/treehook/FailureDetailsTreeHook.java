...
/**
 * A tree hook that sets failure details on the response.
 */
@TreeHook.Metadata(configClass = SetFailureDetailsNode.Config.class)
public class FailureDetailsTreeHook extends DetailsTreeHook {

    private final SetFailureDetailsNode.Config config;
    private final TreeFailureResponse response;
    private final JsonValue data;

    @Inject
    FailureDetailsTreeHook(@Assisted SetFailureDetailsNode.Config config,
