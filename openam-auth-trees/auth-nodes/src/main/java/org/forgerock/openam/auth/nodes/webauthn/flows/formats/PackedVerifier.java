 ...
 */
public class PackedVerifier implements AttestationVerifier {
    ...
    /**
     * Consgtruct a new PackedVerifier.
     *
     * @param flowUtilities Utilities used in webauthn flows.
     */
    public PackedVerifier(FlowUtilities flowUtilities) {
    ...
    private VerificationResponse performCertAttestation(AttestationObject attestationObject, byte[] clientDataHash) {
        ...
        return new VerificationResponse(AttestationType.BASIC, isSignatureValid, cert);
    }
