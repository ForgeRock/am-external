...
public enum CoseAlgorithm {
    ...
    /** the es256 algorithm. */
    ES256("ES256", -7, "SHA256withECDSA", KeyType.EC),

    /** the es512 algorithm. */
    ES512("ES512", -36, "SHA512withECDSA", KeyType.EC),

    /** the es384 algorithm. */
    ES384("ES384", -35, "SHA384withECDSA", KeyType.EC),

    /** the RS256 algorithm. */
    RS256("RS256", -257, "SHA256withRSA", KeyType.RSA),

    /** the RS384 algorithm. */
    RS384("RS384", -258, "SHA384withRSA", KeyType.RSA),

    /** the RS512 algorithm. */
    RS512("RS512", -259, "SHA512withRSA", KeyType.RSA);
     ...
     */
    CoseAlgorithm(String name, int coseNumber, String exactAlgorithmName, KeyType keyType) {
        this.name = name;
