...
public class SocialNode extends AbstractSocialAuthLoginNode {
     ...
     */
    @Inject
    public SocialNode(@Named("CloseableHttpClientHandler") Handler handler, @Assisted SocialNode.Config config,
            @Assisted Realm realm, SocialOAuth2Helper authModuleHelper, ProfileNormalizer profileNormalizer,
            LegacyIdentityService identityService, @Assisted UUID nodeId) throws NodeProcessException {
