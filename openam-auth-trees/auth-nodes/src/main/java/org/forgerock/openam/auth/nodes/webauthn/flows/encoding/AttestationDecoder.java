...
public class AttestationDecoder {
    ...
    private AttestationVerifier getAttestationVerifier(String fmt, AttestationPreference attestationPreference,
        ...
        case "android-safetynet":
            logger.warn("android-safetynet not a supported attestation format");
            throw new DecodingException("Unacceptable attestation format provided - android-safetynet not supported.");
        case "android-key":
