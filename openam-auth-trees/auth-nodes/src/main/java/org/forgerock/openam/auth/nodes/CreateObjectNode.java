...
import static org.forgerock.openam.auth.nodes.helpers.IdmIntegrationHelper.createObject;
...
public class CreateObjectNode implements Node {
    ...
    public Action process(TreeContext context) throws NodeProcessException {
        ...
        if (objectHasAllRequiredFields(context, newObject)) {
            try {
                ...
                JsonValue createdObject = createObject(idmIntegrationService, realm, context.request.locales,
     ...
     */
    public static class CreateObjectOutcomeProvider implements org.forgerock.openam.auth.node.api.OutcomeProvider {
        @Override
