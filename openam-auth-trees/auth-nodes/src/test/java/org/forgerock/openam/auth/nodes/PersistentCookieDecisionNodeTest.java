...
public class PersistentCookieDecisionNodeTest {
    ...
    @Before
    public void setup() {
        persistentCookieDecisionNode = new PersistentCookieDecisionNode(config, coreWrapper, identityUtils,
    ...
    public void givenUsernameFoundInCookieThenUserIsIdentified()
        ...
        assertThat(action.identifiedIdentity).contains(new IdentifiedIdentity("demo", IdType.USER.getName()));
    }
