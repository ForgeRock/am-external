...
public class WaitingHelperTest {
    ...
    private UUID uuid;
    private TimeTravelUtil.FrozenTimeService frozenTimeService = TimeTravelUtil.FrozenTimeService.INSTANCE;
        ...
        describe("Waiting helper", () -> {
            ...
            when("seconds to wait is a positive integer", () -> {
                beforeEach(() -> {
                    ...
                    frozenTimeService.setCurrentTimeMillis(INITIAL_TIME_MILLIS);
                    TimeTravelUtil.setBackingTimeService(frozenTimeService);
