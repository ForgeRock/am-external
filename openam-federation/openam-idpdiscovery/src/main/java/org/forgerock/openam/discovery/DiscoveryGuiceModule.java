...
public class DiscoveryGuiceModule extends AbstractModule {
    ...
    @Provides
    @Inject
    RedirectUrlValidator<RedirectUrlValidator.GlobalService> getGlobalRedirectUrlValidator(
            ValidDomainExtractor<RedirectUrlValidator.GlobalService> urlExtractor) {
