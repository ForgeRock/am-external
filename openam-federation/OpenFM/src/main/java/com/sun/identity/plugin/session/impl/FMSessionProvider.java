...
public class FMSessionProvider implements SessionProvider {
    ...
    private static Logger debug = LoggerFactory.getLogger(FMSessionProvider.class);;
...
*/
        ...
        if (response != null) {
            if (urlRewriteEnabled && targetApplication != null) {
                ...
                if (n > 0) {
                    ...
                    targetApplication.append(targetApplication.toString());
                }
            }   
        }
    ...
    public Object getSession(HttpServletRequest request)
        ...
        try {
            ...
            debug.debug("FMSessionProvider.getSession: Could not get the session" +
