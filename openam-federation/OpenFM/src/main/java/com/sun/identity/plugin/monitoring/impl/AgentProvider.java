...
import com.sun.identity.monitoring.MBeanProvider;
...
public class AgentProvider implements FedMonAgent
{
    ...
    public Object getSaml1SvcMBean() {
        return MBeanProvider.getSaml1SvcMBean();
    }
    ...
    public Object getSaml2SvcMBean() {
        return MBeanProvider.getSaml2SvcMBean();
    }
    ...
    public Object getIdffSvcMBean() {
        return MBeanProvider.getIdffSvcMBean();
    }
    ...
    public Object getFedCOTsMBean() {
        return MBeanProvider.getFedCOTsMBean();
    }
    ...
    public Object getFedEntsMBean() {
        return MBeanProvider.getFedEntsMBean();
    }
}
