...
class ServiceListenerImpl implements ServiceListener {
    ...
    private static Logger debug = LoggerFactory.getLogger(ServiceListenerImpl.class);
    ...
    public void schemaChanged(String serviceName, String version) {
        ...
        if (debug.isDebugEnabled()) {
            debug.debug("ServiceListenerImpl.schemaChanged: service = " +
                serviceName);
        }
    ...
    public void organizationConfigChanged(String serviceName, String version,
        ...
        if (debug.isDebugEnabled()) {
            debug.debug("ServiceListenerImpl.organizationConfigChanged: " +
                "service = " + serviceName);
        }
        ConfigurationActionEvent caevent = new ConfigurationActionEventImpl(
