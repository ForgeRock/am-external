...
public class Federation extends AMLoginModule {
    ...
    private static Logger debug = LoggerFactory.getLogger(Federation.class);
    ...
    throws AuthLoginException {
        ...
        /*
            ...
            userName = array[0];
        */
        debug.debug("Module is successful");
    ...
    public void destroyModuleState() {
        debug.debug("clean up module state");
        userName = null;
        userPrincipal = null;
    }
}
