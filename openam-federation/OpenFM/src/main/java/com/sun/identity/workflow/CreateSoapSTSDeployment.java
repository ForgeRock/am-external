...
public class CreateSoapSTSDeployment extends Task {
    ...
    public String execute(Locale locale, Map mapParams) throws WorkflowException {
        try {
            ...
            LoggerFactory.getLogger("workflow").error("Exception caught in CreateSoapSTSDeployment#execute: " + e.getMessage());
            throw e;
        }
    }
    ...
    private Path getDeploymentBaseDirectory() {
        return Paths.get(
                SystemProperties.getConfigPath(), SOAP_DEPLOYMENT_DIRECTORY_NAME);
    }
     ...
     */
    private String getAgentPasswordEncryptionKey() {
        return new RandomPasswordGenerator().generatePassword();
    }
