...
/**
 * The <code>SPAdapterPlugin</code> provides contracts to perform user specific logics during SAMLv2
 ...
 * <p>
 * A singleton instance of the class implementing <code>SPAdapterPlugin</code>
 * contracts will be used per Service Provider during runtime, so make sure
 * implementation of the methods are thread safe.
 */
@EvolvingAll
public interface SPAdapter extends InitializablePlugin {
     ...
     * @param idpEntityID entity id for the IDP to which the request will be sent. This will be null in ECP case
     * @param realm Realm of the hosted SP
     * @param request servlet request
     * @param response servlet response
     * @param authnRequest the authentication request to be sent to the IDP
     * @exception SAML2Exception if user want to fail the process.
     */
    default void preSingleSignOnRequest(String hostedEntityID, String idpEntityID, String realm,
            HttpServletRequest request, HttpServletResponse response, AuthnRequest authnRequest) throws SAML2Exception {
    }


    /**
     * Invokes when the <code>FAM</code> received the Single-Sign-On response from the IDP,
     * this is called before any processing started on SP side.
     *
     * @param hostedEntityID entity ID for the hosted SP
     * @param realm Realm of the hosted SP
     * @param request servlet request
     * @param response servlet response
     * @param authnRequest the original authentication request sent from SP, null if this is IDP initiated SSO
     ...
     * @exception SAML2Exception if user want to fail the process
     */
    default void preSingleSignOnProcess(String hostedEntityID, String realm, HttpServletRequest request,
            HttpServletResponse response, AuthnRequest authnRequest, Response ssoResponse,
            String profile) throws SAML2Exception {
    }
     ...
     * @exception SAML2Exception if user want to fail the process
     */
    default boolean postSingleSignOnSuccess(String hostedEntityID, String realm, HttpServletRequest request,
     ...
     *     <code>SAML2Constants.HTTP_ARTIFACT</code>,
     *     <code>SAML2Constants.PAOS</code>
     * @param failureCode an integer specifies the failure code. Possible failure codes are defined in this interface
     * @return true if browser redirection happened, false otherwise. Default to false
     */
    default boolean postSingleSignOnFailure(String hostedEntityID, String realm, HttpServletRequest request,
            HttpServletResponse response, AuthnRequest authnRequest, Response ssoResponse,
     ...
     * @param request servlet request
     * @param response servlet response
     * @param userID Universal ID of the user with whom the new name identifier request performed
     * @param idRequest New name identifier request, value will be null if the request object is not available
     * @param idResponse New name identifier response, value will be null if the response object is not available
     ...
     */
    default void postNewNameIDSuccess(String hostedEntityID, String realm, HttpServletRequest request,
     ...
     * @param request servlet request
     * @param response servlet response
     * @param userID Universal ID of the user with whom name id termination performed
     * @param idRequest Terminate name identifier request
     * @param idResponse Terminate name identifier response, value will be null if the response object is not available
     * @param binding binding used for Terminate Name Identifier request,
     *      one of following values:
     *		<code>SAML2Constants.SOAP</code>,
     *		<code>SAML2Constants.HTTP_REDIRECT</code>
     */
    default void postTerminateNameIDSuccess(String hostedEntityID, String realm, HttpServletRequest request,
            HttpServletResponse response, String userID, ManageNameIDRequest idRequest,
            ManageNameIDResponse idResponse, String binding) {
    }

    /**
     * Invokes before single logout process started on <code>SP</code> side. This method is called before the user
     * session is invalidated on the service provider side.
     *
     * @param hostedEntityID Entity ID for the hosted SP
     * @param realm Realm of the hosted SP
     * @param request servlet request
     ...
     * @param logoutResponse single logout response, value will be null if the response object is not available
     ...
     * @exception SAML2Exception if user want to fail the process
     */
    default void preSingleLogoutProcess(String hostedEntityID, String realm, HttpServletRequest request,
            HttpServletResponse response, String userID, LogoutRequest logoutRequest, LogoutResponse logoutResponse,
     ...
     * @param response servlet response
     * @param userID universal ID of the user
     * @param logoutRequest single logout request, value will be null if the request object is not available
     * @param logoutResponse single logout response, value will be null if the response object is not available
     * @param binding binding used for Single Logout request,
     *      one of following values:
     *		<code>SAML2Constants.SOAP</code>,
     *		<code>SAML2Constants.HTTP_REDIRECT</code>
     */
     default void postSingleLogoutSuccess(String hostedEntityID, String realm, HttpServletRequest request,
            HttpServletResponse response, String userID, LogoutRequest logoutRequest, LogoutResponse logoutResponse,
            String binding) {
    }
}
