...
/**
 * This interface <code>IDPFinder</code> is used to find a list of
 * preferred Identity Authenticating providers to service the authentication
 * request.
 */
@EvolvingAll
public interface IDPFinder extends SAMLPlugin {
     ...
     */
    List getPreferredIDP(AuthnRequest authnRequest, String hostProviderID, String realm, HttpServletRequest request,
