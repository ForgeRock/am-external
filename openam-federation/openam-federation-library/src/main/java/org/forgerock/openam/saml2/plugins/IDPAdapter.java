...
/**
 * This interface <code> IDPAdapter</code> is used to perform specific tasks in the IdP.
 */
@EvolvingAll
public interface IDPAdapter extends InitializablePlugin {
     ...
     */
    boolean preSingleSignOn(String hostedEntityID, String realm, HttpServletRequest request,
            HttpServletResponse response, AuthnRequest authnRequest, String reqID) throws SAML2Exception;
     ...
     * @throws SAML2Exception for any exceptions occurring in the adapter. The federation process will continue
     */
    boolean preAuthentication(String hostedEntityID, String realm, HttpServletRequest request,
     ...
     * {@link IDPAdapter#preSendFailureResponse(String, String, HttpServletRequest, HttpServletResponse, String, String)}.
     ...
     * IDPAdapter#preSendFailureResponse(String, String, HttpServletRequest, HttpServletResponse, String, String)}.
     */
    @Deprecated(forRemoval = true, since = "7.2.0")
    void preSendFailureResponse(HttpServletRequest request, HttpServletResponse response,
     ...
     * @throws SAML2Exception if error occurs. The federation process will continue
     */
    default void preSendFailureResponse(String hostedEntityID, String realm, HttpServletRequest request,
            HttpServletResponse response, String faultCode, String faultDetail) throws SAML2Exception {
