...
public class ConditionImpl
    ...
    */
    ...
    public DocumentFragment toDocumentFragment(Document document, boolean includeNSPrefix, boolean declareNS)
        ...
        Element conditionElement = XMLUtils.createRootElement(document, ASSERTION_PREFIX, ASSERTION_NAMESPACE_URI,
                CONDITION_ELEMENT, includeNSPrefix, declareNS);
        fragment.appendChild(conditionElement);
        return fragment;
    }
}
