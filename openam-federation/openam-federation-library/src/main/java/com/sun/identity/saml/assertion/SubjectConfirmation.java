...
public class SubjectConfirmation {
    private static final Logger logger = LoggerFactory.getLogger(SubjectConfirmation.class);
     ...
     * @throws SAMLException If there was an error while constructing this object.
     */
        ...
        throws SAMLException 
    {
        ...
        if (eltName == null)  {
            if (logger.isDebugEnabled()) {
                logger.debug("SubjectConfirmation: local name "
                        + "missing");
            }
        ...
        if (!(eltName.equals("SubjectConfirmation")))  {
            if (logger.isDebugEnabled()) {
                logger.debug("SubjectConfirmation: "+
        ...
        if (_confirmationMethodList.isEmpty()) {
            if (logger.isDebugEnabled()) 
                logger.debug("SubjectConfirmation: Mandatory "
        ...
        throws SAMLException 
    {
        if ((confirmationMethod == null) ||
            ...
            if (logger.isDebugEnabled()) {
                logger.debug("SubjectConfirmation:  null "
    ...
    public SubjectConfirmation(Set confirmationMethods) throws SAMLException {
        if (confirmationMethods.isEmpty()) {
            if (logger.isDebugEnabled()) {
                logger.debug("SubjectConfirmation:  No "
