...
public class ClientFaultException extends FederatedSSOException {
     ...
     */
    public ClientFaultException(final String messageCode) {
     ...
     */
    public ClientFaultException(final String messageCode, final String detail) {
    ...
    public String getFaultCode() {
        return SAML2Constants.CLIENT_FAULT;
    }
}
