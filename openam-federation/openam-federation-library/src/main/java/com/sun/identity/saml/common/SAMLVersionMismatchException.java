 ...
 *
 * $Id: SAMLVersionMismatchException.java,v 1.2 2008/06/25 05:47:35 qcheng Exp $
 *
...
public class SAMLVersionMismatchException extends SAMLException {
     ...
     */
    public SAMLVersionMismatchException(String s) {
        super(s);
    }

    /**
     * Constructs an <code>SAMLVersionMismatchException</code> with given
     * <code>Throwable</code>.
     *
     * @param t Exception nested in the new exception.
     *
     */
    public SAMLVersionMismatchException(Throwable t) {
        super(t);
    }

    /**
     * Constructs a new <code>SAMLVersionMismatchException</code> without a
     ...
     *
     */
    public SAMLVersionMismatchException(String rbName,
                                        String errorCode,
                                        Object[] args)
    {
