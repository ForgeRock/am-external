...
public class EncryptableNameIdentifier {
     ...
     * Constructor creates <code>EncryptableNameIdentifier</code> object.
     *
     * @param name The name of the NameIdentifier.
     * @param nameQualifier The nameQualifier of the NameIdentifier.
     * @param format The format of the NameIdentifier.
     * @param issueInstant the Issue Instant
     * @param nonce The nonce of the NameIdentifier.
     * @throws FSException if there is an error.
     */
