...
public class AuthorityBinding  {
    private static final Logger logger = LoggerFactory.getLogger(AuthorityKindType.class);
 ...
 */
    ...
    public AuthorityBinding(Element element) throws SAMLException {
        ...
        if (element == null) {
            logger.debug("AuthorityBinding: Input is null.");
        ...
        if ((tag == null) || (!tag.equals("AuthorityBinding"))) {
            logger.debug("AuthorityBinding: wrong input");
            throw new SAMLRequesterException(
        ...
        if ( _location == null) {
            if (logger.isDebugEnabled()) {
                logger.debug("AuthorityBinding: Location is " +
                                        "required attribute");
            }
            throw new SAMLRequesterException(
                        SAMLUtilsCommon.bundle.getString("missingAttribute"));
        ...
        if ( _binding == null) {
            if (logger.isDebugEnabled()) {
                logger.debug("AuthorityBinding: Binding is" +
                                        " required attribute");
            }
            throw new SAMLRequesterException(
                        SAMLUtilsCommon.bundle.getString("missingAttribute"));
    ...
    public AuthorityBinding(int authKind, String location, String binding)
        ...
        if (location == null || location.length() == 0){
            if (logger.isDebugEnabled()) {
                  logger.debug("AuthorityBinding: The " +
        ...
        if (authKind >= AuthorityKindType.AUTHENTICATION &&
            ...
            if (logger.isDebugEnabled()) {
                 logger.debug("AuthorityBinding:The type of "+
