...
public class ManageNameIDRequestInfo extends CacheObject {
    private static final Logger logger = LoggerFactory.getLogger(ManageNameIDRequestInfo.class);
    Map paramsMap;
    ManageNameIDRequest mniRequest;
    String relayState;
    HttpServletRequest request;
    HttpServletResponse response;
    private static Logger debug = LoggerFactory.getLogger(ManageNameIDRequestInfo.class);
