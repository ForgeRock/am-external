...
public class AuthenticationQuery extends SubjectQuery {
     ...
     * Constructor.
     *
     * @param subject the Subject of the <code>AuthenticationQuery</code>. May not be null.
     * @param authMethod the <code>AuthenticationMethod</code> in string format. It could be null.
     * @throws SAMLException If subject was null.
     */
