 ...
 *
 * $Id: COTServiceListener.java,v 1.3 2008/06/25 05:46:38 qcheng Exp $
 *
...
public class COTServiceListener implements ConfigurationListener {
    ...
    private static final Logger logger = LoggerFactory.getLogger(COTServiceListener.class);
    ...
    public void configChanged(ConfigurationActionEvent e) {
        if (logger.isDebugEnabled()) {
            logger.debug("COTServiceListener.configChanged:");
        }
        COTCache.clear();
    }
}
