...
public class DefaultFedletAdapter extends FedletAdapter {
    ...
    private static final Logger logger = LoggerFactory.getLogger(DefaultFedletAdapter.class);
        ...
        try {
            ...
            if (strCookies != null) {
                if (logger.isDebugEnabled()) {
                    logger.debug(method + "Sending cookies : " +
                        strCookies);
                }
            ...
            if (conn.getResponseCode() == HttpURLConnection.HTTP_OK) {
                if (logger.isDebugEnabled()) {
                    logger.debug(method + "Response code OK");
                }
                status = true;
            } else {
                logger.error(method + "Response code NOT OK: "
