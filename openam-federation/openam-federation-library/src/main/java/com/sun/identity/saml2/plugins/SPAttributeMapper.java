...
public interface SPAttributeMapper {
     ...
     * @param userID Universal identifier of the user. May be null if the local account is not yet linked.
     ...
     */
    Map<String, Set<String>> getAttributes(List<Attribute> attributes, String userID, String hostEntityID,
