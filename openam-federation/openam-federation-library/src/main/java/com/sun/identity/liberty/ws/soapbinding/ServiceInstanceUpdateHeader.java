...
public class ServiceInstanceUpdateHeader {
    private static final Logger logger = LoggerFactory.getLogger(ServiceInstanceUpdateHeader.class);
    ...
    ServiceInstanceUpdateHeader(Element siuElement)
        ...
        for(int i = 0; i < length; i++) {
            ...
            if (child.getNodeType() == Node.ELEMENT_NODE) {
                ...
                if (!SOAPBindingConstants.NS_SOAP_BINDING_11
                    ...
                    logger.error("ServiceInstanceUpdateHeader: " + msg);
        ...
        if (str != null && str.length() > 0) {
            try {
                ...
                logger.error("ServiceInstanceUpdateHeader: " + msg, pe);
                throw new SOAPBindingException(msg);
            }
        }
