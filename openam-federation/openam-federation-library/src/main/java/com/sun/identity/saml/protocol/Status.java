...
public class Status {
    ...
    /**
     * Constructor.
     * @param code <code>StatusCode</code>. May not be null.
     * @param message A String that is the <code>StatusMessage</code> of the response. It could be null when there is no
     * <code>StatusMessage</code>. May be null, but may not be empty.
     ...
     * @throws SAMLException If the provided status code was null or if the message was empty.
     */
     ...
     *
     * @param code <code>StatusCode</code>. May not be null.
     * @throws SAMLException If the provided status code was null.
     */
