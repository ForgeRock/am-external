...
public class CorrelationHeader {
    private static final Logger logger = LoggerFactory.getLogger(CorrelationHeader.class);
    ...
    CorrelationHeader(Element correlationElement) throws SOAPBindingException {
        ...
        if (messageID == null) {
            ...
            logger.error("CorrelationHeader: " + msg);
        ...
        if (str != null && str.length() > 0) {
            try {
                ...
                logger.error("CorrelationHeader: " + msg, pe);
                throw new SOAPBindingException(msg);
            }
        }
