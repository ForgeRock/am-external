...
{
    private static Logger debug = LoggerFactory.getLogger(WSFederationMetaCache.class);
    ...
    static FederationElement getFederation(String realm, String federationId) {
        ...
        if (debug.isDebugEnabled()) {
            debug.debug("WSFederationMetaCache.getEntityDescriptor: " + 
            ...
            FederationElement federation)
    {
        ...
        if (federation != null) {
            if (debug.isDebugEnabled()) {
                debug.debug("WSFederationMetaCache.putFederation: " + 
                    "cacheKey = " + cacheKey);
            }
