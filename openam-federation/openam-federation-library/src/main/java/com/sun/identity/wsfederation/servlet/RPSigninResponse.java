...
public class RPSigninResponse extends WSFederationAction {
    private static final Logger logger = LoggerFactory.getLogger(RPSigninResponse.class);

    private static Logger debug = LoggerFactory.getLogger(RPSigninResponse.class);
    ...
    public void process() throws WSFederationException, IOException {
        ...
        if ( debug.isDebugEnabled() ) {
            debug.debug(classMethod +"Received RSTR: "
                    + rstr.toString());
        }
        ...
        if (debug.isDebugEnabled()) {
            debug.debug(classMethod + "timeskew = " + timeskew);
        }
        ...
        if ( debug.isDebugEnabled() ) {
            debug.debug(classMethod +" - verifying assertion");
        }
