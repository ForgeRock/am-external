...
public final class WSFederationMetaSecurityUtils {
    ...
    private static Logger debug = LoggerFactory.getLogger(WSFederationMetaSecurityUtils.class);
...
*/
        ...
        throws WSFederationMetaException
    {
        ...
        if (debug.isDebugEnabled()) {
            debug.debug(classMethod + "# of signatures = " + numSigs);
        }
        ...
        for(int i = 0; i < numSigs; i++) {
            ...
            if (debug.isDebugEnabled()) {
                debug.debug(classMethod + "verifying signature under " + 
                    sigParentName);
            }
