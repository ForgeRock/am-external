...
public class IPSigninRequest extends WSFederationAction {
    private static Logger debug = LoggerFactory.getLogger(IPSigninRequest.class);
    ...
    public void process() throws IOException, WSFederationException
    {
        ...
        if (realm.equalsIgnoreCase(sessionRealm)) {
            ...
            if (debug.isDebugEnabled()) {
                debug.debug(classMethod + "The users realm: " + sessionRealm + " was different to the IDP's realm: "
        ...
        throws IOException, ServletException
    {
        ...
        if (debug.isDebugEnabled()) {
            debug.debug(classMethod + "wresult before encoding: " + wresult);
        }
