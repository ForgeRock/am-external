...
public class FedletDataStoreProvider implements DataStoreProvider {
    ...
    private static Logger debug = LoggerFactory.getLogger(FedletDataStoreProvider.class);

    /**
     * Default Constructor.
     */
    public FedletDataStoreProvider() {
        debug.debug("FedletDataStoreProvider.constructor()");
    }
    ...
    public Set<String> getAttribute(String userID, String attrName)
        throws DataStoreProviderException
    {
        debug.debug("FedletDataStoreProvider.getAttribute(String, String)");
        return null;
    }
    ...
    public Map<String, Set<String>> getAttributes(String userID, Set<String> attrNames)
        throws DataStoreProviderException
    {
        debug.debug("FedletDataStoreProvider.getAttribute(String, Set)");
        return null;
    }
    ...
    public byte[][] getBinaryAttribute(String userID, String attrName)
        throws DataStoreProviderException
    {
        debug.debug("FedletDataStoreProvider.getBinaryAttribute(String, String)");
        return null;
    }
    ...
    public Map<String, byte[][]> getBinaryAttributes(String userID, Set<String> attrNames)
        throws DataStoreProviderException
    {
        debug.debug("FedletDataStoreProvider.getBinaryAttributes(String, Set)");
        return null;
    }
    ...
    public void setAttributes(String userID, Map<String, Set<String>> attrMap)
        throws DataStoreProviderException
    {
        debug.debug("FedletDataStoreProvider.setAttribute(String, Map)");
    }
    ...
    public String getUserID(String orgDN, Map<String, Set<String>> avPairs)
        throws DataStoreProviderException
    {
        debug.debug("FedletDataStoreProvider.getUserID(String, Map)");
        return null;
    }
    ...
    public boolean isUserExists(String userID) 
        throws DataStoreProviderException
    {
        debug.debug("FedletDataStoreProvider.isUserExists(String)");
        return false;
    }
}
