...
public class XACMLRequestProcessor {
    ...
    private static final Logger logger = LoggerFactory.getLogger(XACMLRequestProcessor.class);
     ...
     * @throws XACMLException If can not return an instance of <code>XACMLRequestProcessor</code>.
     */
