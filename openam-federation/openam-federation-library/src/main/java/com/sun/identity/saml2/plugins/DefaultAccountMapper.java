...
public class DefaultAccountMapper {
     ...
     private static Logger debug = LoggerFactory.getLogger(DefaultAccountMapper.class);
     ...
     public DefaultAccountMapper() {
         debug.debug("DefaultAccountMapper.constructor: ");
     }
    ...
    public String getIdentity(
        ...
        if(debug.isDebugEnabled()) {
           debug.debug("DefaultAccountMapper.getIdentity(ManageNameIDReq)"+
    ...
    protected String getAttribute(String realm,
	   String entityID, String attributeName) {
        ...
        if(realm == null || entityID == null || attributeName == null ) {
           if(debug.isDebugEnabled()) {
              debug.debug("DefaultAccountMapper.getAttribute: " +
	...
	try {
		...
		if(debug.isDebugEnabled()) {
		  ...
		  "Entity " + entityID + " realm =" + realm + " role=" + role);
            ...
            if(debug.isDebugEnabled()) {
		debug.debug("DefaultSPAccountMapper.getAttribute: " +
		...
		debug.warn("DefaultSPAccountMapper.getAttribute:" +
		"Meta Exception", sme);
            }
	}
        return null;
