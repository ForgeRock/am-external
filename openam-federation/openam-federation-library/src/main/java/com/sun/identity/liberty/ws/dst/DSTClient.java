...
public class DSTClient {
     ...
     * @exception DSTException If there was an error while parsing the resource offering.
     */
     ...
     * @exception DSTException If there was n error while generating the binary security token.
     */
     ...
     * @param requestObjects List of Request Objects.
