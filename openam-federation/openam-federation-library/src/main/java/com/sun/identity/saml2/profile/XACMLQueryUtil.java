...
public class XACMLQueryUtil {
    ...
    private static final Logger logger = LoggerFactory.getLogger(XACMLQueryUtil.class);
    ...
    static {
        try {
            ...
            logger.error("Error retrieving session provider.", se);
        }
    }
