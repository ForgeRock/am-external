...
public class SAMLClient {   
     ...
     * @throws SAMLException If there was an error while creating the SOAP message.
     */
     ...
     * @throws SAMLException If there was an error while retrieving the assertions from the response.
     */
