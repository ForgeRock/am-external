...
public class AuthnQueryImplTest {

    public static Object[][] xmlTestCases() {
        return new Object[][] {
                { true, true, "<samlp:AuthnQuery xmlns:samlp=\"urn:oasis:names:tc:SAML:2.0:protocol\" " +
                        ...
                        "</samlp:AuthnQuery>" },
                { true, false, "<samlp:AuthnQuery " +
                        "Consent=\"testConsent\" " +
                        "Destination=\"https://test.example.com/\" " +
                        "ID=\"testID\" IssueInstant=\"2009-02-13T23:31:30Z\" " +
                        "SessionIndex=\"testIndex\" Version=\"2.0\">" +
                        "<saml:Issuer NameQualifier=\"testNameQualifier\">testIssuer</saml:Issuer>" +
                        "<samlp:Extensions>" +
                ...
                { false, false, "<AuthnQuery " +
                        ...
                        "<AuthnContextClassRef>b</AuthnContextClassRef>" +
                        "</RequestedAuthnContext></AuthnQuery>" }
        };
    }
    ...
    public void testToXmlString(boolean includeNS, boolean declareNS, String expectedXml) throws Exception {
        // Given
        AuthnQueryImpl query = new AuthnQueryImpl();
        query.setID("testID");
        ...
        query.setIssueInstant(new Date(1234567890123L));
        ...
        query.setSessionIndex("testIndex");
        ...
        query.setRequestedAuthnContext(requestedAuthnContext);
