...
<%! private final Logger logger = LoggerFactory.getLogger("jsp.saml2.fedletSSOInit"); %>
...
<%
    ...
    if ((idpEntityID == null) || (idpEntityID.length() == 0)) {
        ...
        if ((idpEntities == null) || idpEntities.isEmpty()) {
            ...
            SAMLUtils.sendError(request, response, response.SC_BAD_REQUEST, "idpNotFound",
                    SAML2Utils.bundle.getString("idpNotFound"));
            return;
