...
<%! private final Logger logger = LoggerFactory.getLogger("jsp.fedletAttrResp"); %>
...
<%
	...
	if ((spEntityID == null) || 
        ...
        Map attrMap = AttributeQueryUtil.getAttributesForFedlet(
                                        spEntityID,
                                        idpEntityID,
                                        newNameIDValue,
                                        attrsList,
...
<%
   ...
   logger.error("Error sending AttributeQuery " , ex);
   }
%>
</body>
</html>
