...
public class RADIUS extends AMLoginModule {
    ...
    private static Logger debug = LoggerFactory.getLogger(RADIUS.class);
    ...
    public void init(Subject subject, Map sharedState, Map options) {
        try {
            if (debug.isDebugEnabled()) {
                debug.debug("Radius resbundle locale=" + getLoginLocale());
            }
            ...
            if (options != null) {
                try {
                    ...
                    if (debug.isDebugEnabled()) {
                        debug.debug("server1: " + primaryServers + " server2: " + secondaryServers + " serverPort: "
    ...
    public int process(Callback[] callbacks, int state) throws AuthLoginException {
        ...
        case ISAuthConstants.LOGIN_START:
            ...
            try {
                ...
                if (debug.isDebugEnabled()) {
                    debug.debug("Radius login request rejected", re);
                }
                ...
                if (debug.isDebugEnabled()) {
                    debug.debug("Server challenge with " + "challengeID: " + challengeID);
                }
        ...
        case ISAuthConstants.LOGIN_CHALLENGE:
            ...
            if (debug.isDebugEnabled()) {
                debug.debug("reply to challenge--username: " + username);
            }
            ...
            try {
                ...
                if (debug.isDebugEnabled()) {
                    debug.debug("Server challenge again with challengeID: " + challengeID);
                }
        ...
        if (succeeded) {
            ...
            if (debug.isDebugEnabled()) {
                debug.debug("userTokenID: " + userTokenId);
            }
            ...
            if (debug.isDebugEnabled()) {
                debug.debug("RADIUS authentication to be ignored");
            }
