...
/**
 * OAuth2 specific configurations for social auth module.
 */
public class SmsSocialAuthOAuth2Configuration extends AbstractSmsSocialAuthConfiguration {
     ...
     */
    SmsSocialAuthOAuth2Configuration(Map<String, Set<String>> options) {
        super(options);
    }
