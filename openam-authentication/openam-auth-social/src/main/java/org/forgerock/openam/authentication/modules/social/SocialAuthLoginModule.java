...
public class SocialAuthLoginModule extends AbstractSocialAuthLoginModule {
    ...
    @VisibleForTesting
    SocialAuthLoginModule(Logger debug, SocialAuthModuleHelper authModuleHelper,
        ...
        super(debug, authModuleHelper, configurationFunction,
                clientTokenJwtGenerator, idmConfigProvider);
    }
