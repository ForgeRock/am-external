...
import static org.forgerock.openam.authentication.modules.oidc.OpenIdConnectConfig.BUNDLE_KEY_ID_TOKEN_BAD_AUDIENCE;
import static org.forgerock.openam.authentication.modules.oidc.OpenIdConnectConfig.BUNDLE_KEY_INVALID_AUTHORIZED_PARTY;
import static org.forgerock.openam.authentication.modules.oidc.OpenIdConnectConfig.BUNDLE_KEY_MISSING_HEADER;
import static org.forgerock.openam.authentication.modules.oidc.OpenIdConnectConfig.BUNDLE_KEY_NO_ATTRIBUTES_MAPPED;
import static org.forgerock.openam.authentication.modules.oidc.OpenIdConnectConfig.BUNDLE_KEY_PRINCIPAL_MAPPER_INSTANTIATION_ERROR;
...
public class OpenIdConnect extends AMLoginModule {
    private static Logger logger = LoggerFactory.getLogger(OpenIdConnect.class);
    ...
    public int process(Callback[] callbacks, int state) throws LoginException {
        ...
        logger.debug("OpenIdConnect:process provided idtoken : {} ", jwtValue);
        ...
        logger.debug("OpenIdConnect:process principal from jwt: {}", principalName);
