...
public class JwkUtilsTest {
    ...
    static void createKeys() throws Exception {
        ...
        rsaKeyPair = new RsaJWK((RSAPublicKey) keyPair.getPublic(), (RSAPrivateKey) keyPair.getPrivate(), ENC,
                "RSA-OAEP-256", "some kid", "some x5u", "some x5t", null);

        secretKey = new OctJWK(ENC, "dir", "some kid", "key bytes", null, null, null);
    }
