...
final class Challenge {
    ...
    static class Builder {
        ...
        Builder signingKey(JWK signingKey) {
            Reject.ifTrue(signingKey.getUse() != null && !SIG.equals(signingKey.getUse()));
            this.challengeSigningKey = signingKey;
            return this;
        }

        Builder responseEncryptionKey(JWK responseEncryptionKey) {
            Reject.ifTrue(responseEncryptionKey.getUse() != null && !ENC.equals(responseEncryptionKey.getUse()));
            this.responseEncryptionKey = responseEncryptionKey;
            return this;
        }
