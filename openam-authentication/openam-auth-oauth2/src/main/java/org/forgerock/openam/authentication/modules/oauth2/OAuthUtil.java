...
import static org.forgerock.openam.authentication.modules.oauth2.OAuthParam.MESSAGE_BODY;
import static org.forgerock.openam.authentication.modules.oauth2.OAuthParam.MESSAGE_SUBJECT;
...
public class OAuthUtil  {
    ...
    static String findCookie(HttpServletRequest request, String cookieName) {
    ...
    static String getParamValue(String query, String param) {
    ...
    static boolean debugMessageEnabled() {
    ...
    static String oAuthEncode(String toEncode) throws UnsupportedEncodingException {
