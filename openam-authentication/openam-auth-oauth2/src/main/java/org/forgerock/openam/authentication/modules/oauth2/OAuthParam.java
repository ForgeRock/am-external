...
public class OAuthParam {
    ...
    public static final String KEY_EMAIL_GWY_IMPL = "org-forgerock-auth-oauth-email-gwy-impl";
    public static final String KEY_SMTP_HOSTNAME = "org-forgerock-auth-oauth-smtp-hostname";
    public static final String KEY_SMTP_PORT = "org-forgerock-auth-oauth-smtp-port";
    public static final String KEY_SMTP_USERNAME = "org-forgerock-auth-oauth-smtp-username";
    public static final String KEY_SMTP_PASSWORD = "org-forgerock-auth-oauth-smtp-password";
    public static final String KEY_SMTP_SSL_ENABLED = "org-forgerock-auth-oauth-smtp-ssl_enabled";
    ...
    // oauthproxy parameters specific to Twitter social provider
    public final static String PARAM_OAUTH_VERIFIER = "oauth_verifier";
