...
public class AdaptivePostAuthenticationPlugin implements AMPostAuthProcessInterface {
    ...
    private static final Logger debug = LoggerFactory.getLogger(AdaptivePostAuthenticationPlugin.class);
    ...
    public void onLoginSuccess(Map requestParamsMap, HttpServletRequest request, HttpServletResponse response,
        ...
        debug.debug("{} executing PostProcessClass", ADAPTIVE);
        ...
        try {
            ...
            if (debug.isDebugEnabled()) {
                debug.debug("{}.getIdentity : Unable to Retrieve PostAuthN Params", ADAPTIVE, e);
            }
        }
    }
