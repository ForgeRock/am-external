...
public class JsonAttributeMapper implements AttributeMapper<String> {
    ...
    private static Logger debug = LoggerFactory.getLogger(JsonAttributeMapper.class);
    ...
    public Map<String, Set<String>> getAttributes(Map<String, String> attributeMapConfiguration, String jsonText)
        ...
        debug.debug("defaultAttributeMapper.getAttributes: {}", attributeMapConfiguration);
        JSONObject json;
        try {
        ...
        for(Map.Entry<String, String> entry : attributeMapConfiguration.entrySet()) {
            try {
                ...
                debug.debug("defaultAttributeMapper.getAttributes: {}={}", responseName, localName);
