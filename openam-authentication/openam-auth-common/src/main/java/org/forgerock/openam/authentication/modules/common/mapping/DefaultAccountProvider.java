...
public class DefaultAccountProvider implements AccountProvider {
    ...
    private static Logger debug = LoggerFactory.getLogger(DefaultAccountProvider.class);
    ...
    public AMIdentity searchUser(IdentityStore idrepo, Map<String, Set<String>> attr) {
        ...
        if (attr == null || attr.isEmpty()) {
            debug.warn("DefaultAccountMapper.searchUser: empty search");
            return null;
        }
        ...
        try {
            ...
            if (iter.hasNext()) {
                ...
                if (debug.isDebugEnabled()) {
                    debug.debug("getUser: user found : " + identity.getName());
                }
            }
