 ...
 * the class itself, therefore enabling unit testing of the authentication logic.
 *
...
public abstract class AuthLoginModule {
    ...
    /**
     * @see AMLoginModuleBinder#getCallback(int)
     */
    public Callback[] getCallback(int state) throws AuthLoginException {
        return amLoginModuleBinder.getCallback(state);
    }

    /**
     * @see AMLoginModuleBinder#replaceCallback(int, int, Callback)
     */
    public void replaceCallback(int state, int index, Callback callback) throws AuthLoginException {
        amLoginModuleBinder.replaceCallback(state, index, callback);
    }

    /**
     * @see AMLoginModuleBinder#storeUsernamePasswd(String, String)
     */
    public void storeUsernameAndPassword(String username, String password) {
        amLoginModuleBinder.storeUsernamePasswd(username, password);
    }

    /**
     * @see AMLoginModuleBinder#getLoginLocale()
     */
    public Locale getLoginLocale() {
        return amLoginModuleBinder.getLoginLocale();
    }

    /**
     * @see AMLoginModuleBinder#substituteHeader(int, String)
     */
    public void substituteHeader(int state, String header) throws AuthLoginException {
        amLoginModuleBinder.substituteHeader(state, header);
    }
}
