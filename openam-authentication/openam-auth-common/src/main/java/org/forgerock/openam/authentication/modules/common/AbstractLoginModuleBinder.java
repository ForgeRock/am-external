 ...
 */
public abstract class AbstractLoginModuleBinder<T extends AuthLoginModule> extends AMLoginModule implements AMLoginModuleBinder {

    protected final T authLoginModule;
     ...
     */
    public AbstractLoginModuleBinder(T authLoginModule) {
