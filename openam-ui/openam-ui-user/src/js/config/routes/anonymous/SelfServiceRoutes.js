...
export default {
    ...
    "forgotUsername": {
        view: () => import("org/forgerock/openam/ui/user/anonymousProcess/ForgotUsernameView"),
        url: /^forgotUsername(\/[^&]*)(&.+)?/,
    ...
    "passwordReset": {
        view: () => import("org/forgerock/openam/ui/user/anonymousProcess/PasswordResetView"),
        url: /^passwordReset(\/[^&]*)(&.+)?/,
    ...
    "selfRegistration": {
        view: () => import("org/forgerock/openam/ui/user/anonymousProcess/SelfRegistrationView"),
        url: /^register(\/[^&]*)(&.+)?/,
        pattern: "register??",
        argumentNames: ["realm", "additionalParameters"],
        defaults: ["/", ""]
