...
const AnonymousProcessView = AbstractView.extend({
    ...
    formSubmit (event) {
        ...
        this.service.submit(formContent).then(
    ...
    parentRender () {
        AbstractView.prototype.parentRender.call(this, _.bind(function () {
            this.service.start().then(_.bind(this.renderProcessState, this));
        }, this));
    },
    ...
    setService (endpoint, token, additional) {
        this.service = new AnonymousProcessDelegate(endpoint, token, additional);
    },

    submitService (params, onSubmit) {
        this.service.submit(_.omit(params, "token")).always(onSubmit);
    },
