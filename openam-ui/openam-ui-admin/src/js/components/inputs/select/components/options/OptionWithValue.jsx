...
/*
 * This custom OptionWithValue component wraps the default react-select v2 componet and adds classNames to the options
 * which are then targeted within our functional tests. For more information @see https://react-select.com/components
 */

const OptionWithValue = ({ children, ...props }) => {
    const isNewOption = props.data.__isNew__;
    const valueSubtitle = isNewOption ? undefined
        : (
...
export default OptionWithValue;
