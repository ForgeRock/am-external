...
// Types
const ADD_OR_UPDATE = "local/config/realm/authentication/trees/list/ADD_OR_UPDATE";
const REMOVE = "local/config/realm/authentication/trees/list/REMOVE";
const SET = "local/config/realm/authentication/trees/list/SET";
