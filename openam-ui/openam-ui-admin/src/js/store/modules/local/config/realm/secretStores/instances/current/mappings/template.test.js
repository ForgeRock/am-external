...
describe("store/modules/local/config/realm/secretStores/instances/current/mappings/template", () => {
        ...
        describe("#set", () => {
            it("creates an action", () => {
                expect(set(template)).eql({
                    payload: template,
                    type: "local/config/realm/secretStores/instances/current/mappings/template/SET"
                });
            });
        });
    });
