...
describe("store/modules/remote/config/global/secretStores/singletons/types/creatables", () => {
        ...
        describe("#addOrUpdate", () => {
            it("creates an action", () => {
                expect(addOrUpdate(creatables, secretStoreType)).eql({
                    ...
                    payload: creatables,
                    type: "remote/config/global/secretStores/singletons/types/creatables/ADD_OR_UPDATE"
                });
            });
        });
    });
