...
describe("store/modules/remote/config/realm/applications/oauth2/softwarePublisher/agents/instances", () => {
    describe("actions", () => {
        const typePrefix = "remote/config/realm/applications/oauth2/softwarePublisher/agents/instances/";
