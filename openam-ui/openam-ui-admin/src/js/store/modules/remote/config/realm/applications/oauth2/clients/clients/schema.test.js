...
describe("store/modules/remote/config/realm/applications/oauth2/clients/clients/schema", () => {
        ...
        describe("#setSchema", () => {
            it("creates an action", () => {
                expect(setSchema(schema)).eql({
                    type: "remote/config/realm/applications/oauth2/clients/clients/schema/SET_SCHEMA",
                    payload: schema
                });
            });
        });
