...
describe("store/modules/remote/config/realm/applications/oauth2/trustedJwtIssuer/groups/template", () => {
    describe("actions", () => {
        describe("#setTemplate", () => {
            it("creates an action", () => {
                expect(setTemplate(template)).eql({
                    type: "remote/config/realm/applications/oauth2/trustedJwtIssuer/groups/template/SET_TEMPLATE",
                    payload: template
                });
            });
        });
