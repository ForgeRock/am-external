...
describe("store/modules/remote/config/realm/applications/oauth2/trustedJwtIssuer/groups/instances", () => {
    describe("actions", () => {
        describe("#addInstance", () => {
            it("creates an action", () => {
                expect(addInstance(groupOne)).eql({
                    type: "remote/config/realm/applications/oauth2/trustedJwtIssuer/groups/instances/ADD_INSTANCE",
                    payload: groupOne
                });
            });
        });
        describe("#setInstances", () => {
            it("creates an action", () => {
                expect(setInstances([groupOne, groupTwo])).eql({
                    type: "remote/config/realm/applications/oauth2/trustedJwtIssuer/groups/instances/" +
                        "SET_INSTANCES",
