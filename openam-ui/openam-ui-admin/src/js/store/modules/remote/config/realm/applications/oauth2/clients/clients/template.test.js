...
describe("store/modules/remote/config/realm/applications/oauth2/clients/clients/template", () => {
        ...
        describe("#setTemplate", () => {
            it("creates an action", () => {
                expect(setTemplate(template)).eql({
                    type: "remote/config/realm/applications/oauth2/clients/clients/template/SET_TEMPLATE",
                    payload: template
                });
            });
        });
