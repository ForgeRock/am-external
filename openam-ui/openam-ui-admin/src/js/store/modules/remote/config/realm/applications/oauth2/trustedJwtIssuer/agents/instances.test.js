...
describe("store/modules/remote/config/realm/applications/oauth2/trustedJwtIssuer/agents/instances", () => {
    describe("actions", () => {
        const typePrefix = "remote/config/realm/applications/oauth2/trustedJwtIssuer/agents/instances/";
