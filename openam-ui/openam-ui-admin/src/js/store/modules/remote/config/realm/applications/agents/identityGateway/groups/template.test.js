...
describe("store/modules/remote/config/realm/applications/agents/identityGateway/groups/template", () => {
        ...
        describe("#setTemplate", () => {
            it("creates an action", () => {
                expect(setTemplate(template)).eql({
                    type: "remote/config/realm/applications/agents/identityGateway/groups/template/SET_TEMPLATE",
                    payload: template
                });
            });
        });
