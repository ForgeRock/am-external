...
describe("store/modules/remote/config/realm/applications/oauth2/trustedJwtIssuer/agents/schema", () => {
    describe("actions", () => {
        describe("#setSchema", () => {
            it("creates an action", () => {
                expect(setSchema(schema)).eql({
                    type: "remote/config/realm/applications/oauth2/trustedJwtIssuer/agents/schema/SET_SCHEMA",
                    payload: schema
                });
            });
        });
