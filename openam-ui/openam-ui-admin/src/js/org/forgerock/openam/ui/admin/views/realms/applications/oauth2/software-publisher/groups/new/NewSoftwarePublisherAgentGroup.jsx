...
class NewSoftwarePublisherAgentGroup extends Component {
    constructor (props) {
        super(props);
        this.state = {
            groupId: ""
    ...
    render () {
        ...
        return (
            <div>
                <PageHeader title={ t("console.applications.oauth2.softwarePublisher.groups.new.title") } />
                <Panel>
...
NewSoftwarePublisherAgentGroup.propTypes = {
...
export default NewSoftwarePublisherAgentGroup;
