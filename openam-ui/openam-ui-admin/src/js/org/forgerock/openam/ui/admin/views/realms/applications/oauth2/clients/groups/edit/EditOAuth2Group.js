...
import EditOAuth2GroupTemplate from
    "templates/admin/views/realms/applications/oauth2/clients/groups/edit/EditOAuth2GroupTemplate";
...
class EditOAuth2Group extends AbstractView {
    render ([realm, id]) {
        const editComponent = new EditSchemaComponent({
            ...
            listRoute: Router.configuration.routes.realmsApplicationsOAuth2Clients,
