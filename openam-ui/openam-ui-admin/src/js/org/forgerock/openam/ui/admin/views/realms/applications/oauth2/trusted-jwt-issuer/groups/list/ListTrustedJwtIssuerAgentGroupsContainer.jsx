...
import { setInstances } from "store/modules/remote/config/realm/applications/oauth2/trustedJwtIssuer/groups/instances";
...
ListTrustedJwtIssuerAgentGroupsContainer = connectWithStore(ListTrustedJwtIssuerAgentGroupsContainer,
    (state) => ({
        groups: values(state.remote.config.realm.applications.oauth2.trustedJwtIssuer.groups.instances)
    }),
    (dispatch) => ({
