...
import EditOAuth2ClientTemplate from
    "templates/admin/views/realms/applications/oauth2/clients/clients/edit/EditOAuth2ClientTemplate";
...
class EditOAuth2Client extends AbstractView {
    constructor () {
        ...
        this.template = EditOAuth2ClientTemplate;
        this.events = {
    ...
    onDelete () {
        showDeleteDialog({
            ...
            onConfirm: async () => {
                try {
                    await remove(this.realm, OAUTH2_CLIENT, [this.data.id]);
                    Router.routeTo(Router.configuration.routes.realmsApplicationsOAuth2Clients, {
