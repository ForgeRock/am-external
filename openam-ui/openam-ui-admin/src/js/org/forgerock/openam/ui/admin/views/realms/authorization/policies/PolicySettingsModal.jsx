...
import ToggleSwitch from "components/inputs/boolean/ToggleSwitch";
                            ...
                            <FormGroup className="clearfix" controlId="policyName">
                                ...
                                <Col sm={ 9 }>
                                    <FormControl
                                        ...
                                        disabled={ this.props.isReadOnlyName }
...
PolicySettingsModal.propTypes = {
    ...
    isReadOnlyName: PropTypes.bool.isRequired
};
