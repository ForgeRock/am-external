...
class NewTrustedJwtIssuerAgentGroup extends Component {
    constructor (props) {
        super(props);
        this.state = {
            groupId: ""
    ...
    render () {
        ...
        return (
            <div>
                <PageHeader title={ t("console.applications.oauth2.trustedJwtIssuer.groups.new.title") } />
                <Panel>
                    <Panel.Body>{ content }</Panel.Body>
                    <Panel.Footer>
                        <CreateFooter
                            backRoute={ Router.configuration.routes.realmsApplicationsOAuth2TrustedJwtIssuer }
...
NewTrustedJwtIssuerAgentGroup.propTypes = {
...
export default NewTrustedJwtIssuerAgentGroup;
