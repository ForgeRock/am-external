...
const resource = (realm, type) => new CRESTv2(url(`/realm-config/federation/entityproviders/${type}`, realm), {
    middleware: [middleware]
});

export const getAll = (realm, type) => resource(realm, type).queryFilter();
