...
import CreatableMultiSelect from "components/inputs/select/CreatableMultiSelect";
 ...
 */
const creatableMultiSelectEditor = (onUpdate, { defaultValue, schema }) => {
    function handleSave () {
...
export default creatableMultiSelectEditor;
