...
import { setSchema } from "store/modules/remote/config/realm/applications/oauth2/softwarePublisher/groups/schema";
import { setTemplate } from "store/modules/remote/config/realm/applications/oauth2/softwarePublisher/groups/template";
...
class NewSoftwarePublisherAgentGroupContainer extends Component {
    ...
    handleCreate = (formData) => {
        ...
        create(realm, SOFTWARE_PUBLISHER, formData, this.state.groupId).then(() => {
            Router.routeTo(Router.configuration.routes.realmsApplicationsOAuth2SoftwarePublisherAgentGroupsEdit,
...
NewSoftwarePublisherAgentGroupContainer = connectWithStore(NewSoftwarePublisherAgentGroupContainer,
    (state) => ({
        schema: state.remote.config.realm.applications.oauth2.softwarePublisher.groups.schema,
        template: state.remote.config.realm.applications.oauth2.softwarePublisher.groups.template
    }),
    (dispatch) => ({
