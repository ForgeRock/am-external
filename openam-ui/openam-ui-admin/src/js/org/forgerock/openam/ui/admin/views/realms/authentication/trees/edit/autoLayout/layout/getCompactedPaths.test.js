...
describe("org/forgerock/openam/ui/admin/views/realms/authentication/trees/edit/autoLayout/layout/getCompactedPaths",
    () => {
        ...
        it("removes all repeating nodes in all paths and removes empty paths", () => {
            expect(getCompactedPaths(paths)).to.deep.equal(compactedPaths);
        });
    });
