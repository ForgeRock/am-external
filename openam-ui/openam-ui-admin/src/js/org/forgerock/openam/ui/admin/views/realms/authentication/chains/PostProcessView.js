...
const PostProcessView = AbstractView.extend({
    ...
    add () {
        const newProcessClass = this.$el.find("[data-new-process-class]").val().trim();
        const invalidName = _.find(this.data.chainData.loginPostProcessClass, (className) => {
