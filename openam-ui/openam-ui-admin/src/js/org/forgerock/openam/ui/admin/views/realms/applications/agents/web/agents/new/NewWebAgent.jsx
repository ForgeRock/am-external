...
import NewWebAgentForm from "./NewWebAgentForm";
import PageHeader from "components/PageHeader";
import Router from "org/forgerock/commons/ui/common/main/Router";

class NewWebAgent extends Component {
    componentDidUpdate () {
    ...
    render () {
        ...
        return (
            <div>
                <PageHeader title={ t("console.applications.agents.web.agents.new.title") } />
                <Panel>
