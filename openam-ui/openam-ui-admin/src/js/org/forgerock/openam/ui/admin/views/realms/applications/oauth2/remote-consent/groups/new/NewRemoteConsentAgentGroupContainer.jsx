...
import { setSchema } from "store/modules/remote/config/realm/applications/oauth2/remoteConsent/groups/schema";
import { setTemplate } from "store/modules/remote/config/realm/applications/oauth2/remoteConsent/groups/template";
...
class NewRemoteConsentAgentGroupContainer extends Component {
    ...
    handleCreate = (formData) => {
        ...
        create(realm, REMOTE_CONSENT_AGENT, formData, this.state.groupId).then(() => {
            Router.routeTo(Router.configuration.routes.realmsApplicationsOAuth2RemoteConsentAgentGroupsEdit,
...
NewRemoteConsentAgentGroupContainer = connectWithStore(NewRemoteConsentAgentGroupContainer,
    (state) => ({
        schema: state.remote.config.realm.applications.oauth2.remoteConsent.groups.schema,
        template: state.remote.config.realm.applications.oauth2.remoteConsent.groups.template
    }),
    (dispatch) => ({
