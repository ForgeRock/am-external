...
import { setSchema } from "store/modules/remote/config/realm/applications/oauth2/trustedJwtIssuer/agents/schema";
import { setTemplate } from "store/modules/remote/config/realm/applications/oauth2/trustedJwtIssuer/agents/template";
...
NewTrustedJwtIssuerAgentContainer = connectWithStore(NewTrustedJwtIssuerAgentContainer,
    (state) => ({
        schema: state.remote.config.realm.applications.oauth2.trustedJwtIssuer.agents.schema,
        template: state.remote.config.realm.applications.oauth2.trustedJwtIssuer.agents.template
    }),
    (dispatch) => ({
