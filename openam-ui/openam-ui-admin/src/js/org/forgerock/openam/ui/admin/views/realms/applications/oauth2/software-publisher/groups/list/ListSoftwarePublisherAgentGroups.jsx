...
const ListSoftwarePublisherAgentGroups = (props) => {
    const columns = [{
        ...
        sort: true,
        text: t("console.applications.oauth2.softwarePublisher.groups.list.grid.0")
    }];
    return (
        <Panel className="fr-panel-tab">
            <Panel.Body>
                <List
                    ...
                    columns={ columns }
                    description={
                        t("console.applications.oauth2.softwarePublisher.groups.list.callToAction.description")
                    }
                    title={ t("console.applications.oauth2.softwarePublisher.groups.list.callToAction.title") }
                />
            </Panel.Body>
        </Panel>
    );
