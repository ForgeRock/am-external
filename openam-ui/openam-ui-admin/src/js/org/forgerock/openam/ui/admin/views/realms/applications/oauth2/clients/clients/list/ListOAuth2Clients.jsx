            ...
            <Panel.Body>
                ...
                >
                    <TableHeaderColumn
                        ...
                        dataSort
                    >
                        { t("console.applications.oauth2.clients.clients.list.grid.0") }
                    </TableHeaderColumn>
                    <TableHeaderColumn
                        ...
                        dataSort
                    >
                        { t("console.applications.oauth2.clients.clients.list.grid.1") }
                    </TableHeaderColumn>
                    <TableHeaderColumn
                        dataField="coreOAuth2ClientConfig"
                        ...
                        dataSort
                    >
                        { t("console.applications.oauth2.clients.clients.list.grid.2") }
                    </TableHeaderColumn>
                </List>
            </Panel.Body>
        </Panel>
