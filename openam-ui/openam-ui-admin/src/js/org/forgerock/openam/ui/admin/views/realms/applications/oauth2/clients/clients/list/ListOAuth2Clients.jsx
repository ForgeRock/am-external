...
const ListOAuth2Clients = (props) => {
    const columns = [{
        ...
        sort: true,
        text: t("console.applications.oauth2.clients.clients.list.grid.0")
    }, {
        dataField: "coreOAuth2ClientConfig",
        formatter: dataFieldObjectPath(identity, "agentgroup"),
        sort: true,
        text: t("console.applications.oauth2.clients.clients.list.grid.1")
    }, {
        dataField: "coreOAuth2ClientConfig",
        formatter: dataFieldObjectPath(StatusCell, "status"),
        sort: true,
        text: t("console.applications.oauth2.clients.clients.list.grid.2")
    }];
    return (
        <Panel className="fr-panel-tab">
            <Panel.Body>
                <List
                    { ...omit(props, "children") }
                    addButton={ {
                        title: t("console.applications.oauth2.clients.clients.list.callToAction.button"),
                        href: props.newHref
                    } }
                    columns={ columns }
                    description={ t("console.applications.oauth2.clients.clients.list.callToAction.description") }
                    title={ t("console.applications.oauth2.clients.clients.list.callToAction.title") }
                />
            </Panel.Body>
        </Panel>
    );
