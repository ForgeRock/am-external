...
import { setSchema } from "store/modules/remote/config/realm/applications/oauth2/clients/groups/schema";
import { setTemplate } from "store/modules/remote/config/realm/applications/oauth2/clients/groups/template";
...
NewOAuth2GroupContainer = connectWithStore(NewOAuth2GroupContainer,
    (state) => ({
        schema: state.remote.config.realm.applications.oauth2.clients.groups.schema,
        template: state.remote.config.realm.applications.oauth2.clients.groups.template
    }),
    (dispatch) => ({
