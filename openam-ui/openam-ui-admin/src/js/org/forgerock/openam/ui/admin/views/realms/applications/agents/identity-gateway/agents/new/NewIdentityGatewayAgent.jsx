...
class NewIdentityGatewayAgent extends Component {
    constructor (props) {
        super(props);
        this.state = {
            agentId: ""
    ...
    render () {
        ...
        return (
            <div>
                <PageHeader title={ t("console.applications.agents.identityGateway.agents.new.title") } />
                <Panel>
...
NewIdentityGatewayAgent.propTypes = {
...
export default NewIdentityGatewayAgent;
