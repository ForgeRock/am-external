...
class NewSoapSTSAgent extends Component {
    constructor (props) {
        super(props);
        this.state = {
            agentId: ""
    ...
    render () {
        ...
        return (
            <div>
                <PageHeader title={ t("console.applications.agents.soapSts.agents.new.title") } />
                <Panel>
...
export default NewSoapSTSAgent;
