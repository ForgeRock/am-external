...
import { setInstances } from "store/modules/remote/config/realm/applications/oauth2/softwarePublisher/groups/instances";
...
class ListSoftwarePublisherAgentGroupsContainer extends Component {
    ...
    render () {
        ...
        const newHref = Router.getLink(
            Router.configuration.routes.realmsApplicationsOAuth2SoftwarePublisherAgentGroupsNew, [
...
ListSoftwarePublisherAgentGroupsContainer = connectWithStore(ListSoftwarePublisherAgentGroupsContainer,
    (state) => ({
        groups: values(state.remote.config.realm.applications.oauth2.softwarePublisher.groups.instances)
    }),
    (dispatch) => ({
