...
import { setInstances } from "store/modules/remote/config/realm/applications/oauth2/remoteConsent/groups/instances";
...
class ListRemoteConsentAgentGroupsContainer extends Component {
    ...
    render () {
        ...
        const newHref = Router.getLink(
            Router.configuration.routes.realmsApplicationsOAuth2RemoteConsentAgentGroupsNew, [
...
ListRemoteConsentAgentGroupsContainer = connectWithStore(ListRemoteConsentAgentGroupsContainer,
    (state) => ({
        groups: values(state.remote.config.realm.applications.oauth2.remoteConsent.groups.instances)
    }),
    (dispatch) => ({
