...
import { setSchema } from "store/modules/remote/config/realm/applications/oauth2/remoteConsent/agents/schema";
import { setTemplate } from "store/modules/remote/config/realm/applications/oauth2/remoteConsent/agents/template";
...
NewRemoteConsentAgentContainer = connectWithStore(NewRemoteConsentAgentContainer,
    (state) => ({
        schema: state.remote.config.realm.applications.oauth2.remoteConsent.agents.schema,
        template: state.remote.config.realm.applications.oauth2.remoteConsent.agents.template
    }),
    (dispatch) => ({
