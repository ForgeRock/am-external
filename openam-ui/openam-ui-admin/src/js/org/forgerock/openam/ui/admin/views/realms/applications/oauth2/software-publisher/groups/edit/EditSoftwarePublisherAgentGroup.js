...
import EditSoftwarePublisherAgentGroupTemplate from "templates/admin/views/realms/applications/oauth2/software-publisher/groups/edit/EditSoftwarePublisherAgentGroupTemplate"; // eslint-disable-line max-len
...
class EditSoftwarePublisherAgentGroup extends AbstractView {
    ...
    onDelete () {
        showDeleteDialog({
            ...
            onConfirm: async () => {
                try {
                    await remove(this.realm, SOFTWARE_PUBLISHER, [this.data.id]);
                    Router.routeTo(Router.configuration.routes.realmsApplicationsOAuth2SoftwarePublisher, {
