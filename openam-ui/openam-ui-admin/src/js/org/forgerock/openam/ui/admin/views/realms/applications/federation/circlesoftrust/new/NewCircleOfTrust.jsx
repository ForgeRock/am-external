...
class NewCircleOfTrust extends Component {
    constructor (props) {
        super(props);
        this.state = {
            name: ""
    ...
    handleNameChange = (name) => {
        this.setState({ name }, () => {
            this.props.onNameChange(isValidId(this.state.name) ? this.state.name : null);
        });
    };
    ...
    render () {
        const isNameValid = isValidId(this.state.name);
        let content;
        ...
        return (
            <div>
                <PageHeader title={ t("console.applications.federation.circlesoftrust.new.title") } />
                <Panel>
                    <Panel.Body>{ content }</Panel.Body>
                    <Panel.Footer>
                        <CreateFooter
                            backRoute={ Router.configuration.routes.realmsApplicationsFederationCirclesOfTrust }
...
export default NewCircleOfTrust;
