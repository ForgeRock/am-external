 ...
 * @returns {@link http://api.jquery.com/Types/#jqXHR|jqXHR} Return value from call to
...
ServiceInvoker.restCall = function (options) {
    ...
    const rejectHandler = function (jqXHR) {
        ...
        if (options.suppressEvents) {
            ...
            /**
             * Handle session expiry by redirecting to the User application for re-authentication.
             * Only do this if there isn't an errorsHandler for 401 included in the request.
             */
