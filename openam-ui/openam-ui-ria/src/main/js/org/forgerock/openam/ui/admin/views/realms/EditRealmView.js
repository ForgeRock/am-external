...
define([
    ...
    "templates/admin/views/realms/EditRealmTemplate",
    "partials/alerts/_Alert",
    "templates/admin/views/realms/EditRealmNameValidationErrorTemplate",

    "popoverclickaway",
    "selectize"
], (i18next, $, _, Messages, AbstractView, EventManager, Router, Constants, RealmsService,
    GlobalAuthenticationService, RealmAuthenticationService, FormHelper, Backlink, JSONSchema, JSONValues,
    FlatJSONSchemaView, Promise, updateDefaultServerAdvancedFqdnMap, EditRealmTemplate, AlertPartial,
    EditRealmNameValidationErrorTemplate) => { // eslint-disable-line padded-blocks
