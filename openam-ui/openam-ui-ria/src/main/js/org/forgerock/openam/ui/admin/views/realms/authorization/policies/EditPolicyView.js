...
define([
    ...
    AbstractView.extend({
        ...
        saveModel () {
            if (!this.newEntity) {
                // Model.save() below triggers reload of the view, we need to manually clean up a react tree
                unmountAt.default(this.$el.find("#summaryTab"));
                unmountAt.default(this.$el.find("#policyFooter"));
            }
