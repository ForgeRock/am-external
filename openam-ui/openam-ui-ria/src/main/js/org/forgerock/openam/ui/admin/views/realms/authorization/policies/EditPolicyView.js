...
define([
    ...
    "templates/admin/views/realms/authorization/policies/EditPolicyTemplate",
    "templates/admin/views/realms/authorization/policies/NewPolicyTemplate",
    "bootstrap-tabdrop",
    "selectize"
    ...
    CreatedResourcesView, PolicyActionsView, PolicySettingsModal, SummaryView, unmountAt, React, HelpLinkPartial,
    PolicyOperationsDropDownPartial, EditPolicyTemplate, NewPolicyTemplate) =>
    AbstractView.extend({
        partials: {
            "templates/admin/views/realms/authorization/policies/_PolicyOperationsDropDown":
