...
define([
    ...
    "templates/admin/views/realms/authentication/chains/EditChainTemplate",
    "partials/alerts/_Alert",
    "templates/admin/views/realms/authentication/chains/_EditChainAlertPartial",
    // jquery dependencies
    "sortable"
], ($, _, AbstractView, Constants, EventManager, EditLinkView, FormHelper, LinkView, Messages,
    PostProcessView, Router, AuthenticationService, EditChainTemplate, AlertPartial, EditChainAlertPartial) => {
