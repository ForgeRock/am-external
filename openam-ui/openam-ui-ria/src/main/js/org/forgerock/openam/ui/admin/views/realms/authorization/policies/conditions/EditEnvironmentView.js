...
define([
    ...
    "templates/admin/views/realms/authorization/policies/conditions/ListItem"
], ($, _, i18next, AbstractView, UIUtils, PoliciesService, BooleanAttr, ArrayAttr, StringAttr, ObjectAttr, EnumAttr,
    TimeAttr, DayAttr, DateAttr, EditEnvironmentTemplate, ListItemTemplate) => {
        ...
        createListItem (allEnvironments, item) {
            ...
            if (mergedData && mergedData.type) {
                ...
                if (type === self.SCRIPT_RESOURCE) {
                    ...
                    PoliciesService.getScriptById(mergedData.scriptId).done((script) => {
            ...
            if (itemData) {
                ...
                setTimeout(() => {
                    ...
                    if (!self.$el.parents("#dropbox").length || self.$el.hasClass("editing")) {
                        self.buildHTML(itemData, hiddenData, schema).done(() => {
                            self.animateIn();
                        });
                    }
                }, delay);
        ...
        buildHTML (itemData, hiddenData, schema) {
            ...
            if (itemData.type === "SimpleTime") {
                ...
                if (itemData && itemData.scriptId) {
                    PoliciesService.getScriptById(itemData.scriptId).done((script) => {
