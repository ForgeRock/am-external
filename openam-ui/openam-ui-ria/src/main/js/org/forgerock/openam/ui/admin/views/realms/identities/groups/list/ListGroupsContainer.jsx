...
import { getAll, remove } from "org/forgerock/openam/ui/admin/services/realm/identities/GroupsService";
...
class ListGroupsContainer extends Component {
    ...
    handleDelete (items) {
        ...
        showConfirmationBeforeAction({
            message: t("console.identities.groups.confirmDeleteSelected", { count: ids.length })
        }, () => {
