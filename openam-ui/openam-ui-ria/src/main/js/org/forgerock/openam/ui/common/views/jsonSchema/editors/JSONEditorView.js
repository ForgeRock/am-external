...
define([
    ...
    const JSONEditorView = Backbone.View.extend({
        ...
        /**
        * Returns form data.
        * @param {boolean} [removeEmptyPasswords=true] Whether to remove empty passwords from the form data or not
        * @returns {Object} form data
        */
        getData (removeEmptyPasswords = true) {
            ...
            if (removeEmptyPasswords) {
                values = values.removeEmptyPasswords(this.options.schema.getPasswordKeys());
            }
