    ...
    return class JSONSchema {
        ...
        getPasswordKeys () {
            ...
            if (this.hasInheritance()) {
                passwordProperties = _.pick(this.raw.properties,
                    _.matchesProperty("properties.value.format", "password"));
            } else {
                passwordProperties = _.pick(this.raw.properties, _.matches({ format: "password" }));
            }
