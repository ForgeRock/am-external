...
define([
    ...
    // jquery dependencies
    "selectize"
], ($, _, AbstractView, Backgrid, BackgridUtils, BootstrapDialog, Constants, EventManager, ShareCounter,
    ...
    CommonShare = AbstractView.extend({
        ...
        save () {
            var permissions = this.parentModel.get("policy").get("permissions"),
                ...
                scopes = _.each(this.$el.find("#selectPermission select")[0].selectize.getValue(), (scope) => {
