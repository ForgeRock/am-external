...
define([
    ...
    "templates/admin/views/realms/scripts/EditScriptTemplate",
    "templates/admin/views/realms/scripts/NewScriptTemplate",
    "templates/admin/views/realms/scripts/ScriptValidationTemplate",
    "templates/admin/views/realms/scripts/ChangeContextTemplate",
    "codemirror/mode/groovy/groovy",
    "codemirror/mode/javascript/javascript",
    "codemirror/addon/display/fullscreen",
    // jquery dependencies
    "selectize"
], ($, _, BootstrapDialog, CodeMirror, ChangesPending, Messages, AbstractView, EventManager, Router, Base64,
    Constants, UIUtils, Script, RealmScriptsService, GlobalScriptsService, FormHelper, Promise,
    AlertPartial, EditScriptTemplate, NewScriptTemplate, ScriptValidationTemplate, ChangeContextTemplate) => {
    return AbstractView.extend({
        ...
        renderAfterSyncModel () {
            ...
            if (this.data.contexts) {
                self.languageSchemaPromise.done((langSchema) => {
        ...
        validateScript () {
            ...
            RealmScriptsService.validateScript(script).done((result) => {
        ...
        openDialog () {
            ...
            if (this.data.defaultContext) {
                ...
                this.defaultContextPromise.done((context) => {
        ...
        changeContext () {
            var self = this,
                selectedContext = _.find(this.data.contexts, (context) => {
                    return context._id === self.data.entity.context;
                }),
                defaultScript,
                promise = $.Deferred();
