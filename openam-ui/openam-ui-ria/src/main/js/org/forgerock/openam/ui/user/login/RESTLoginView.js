...
define([
    ...
    URIUtils, logout, getCurrentFragmentParamString, query, gotoUrl, store) => {
     ...
     */
    function isPollingCallbackPresent (requirements) {
    ...
    var LoginView = AbstractView.extend({
        ...
        */
        ...
        render (args) {
            ...
            this.data.currentFragmentQueryString = getCurrentFragmentParamString();
        ...
        renderForm (reqs, urlParams) {
            ...
            _.each(reqs.callbacks, (element) => {
                ...
                if (element.type === "RedirectCallback") {
                    ...
                    _.delay(() => {
                        ...
                        if (isPollingCallbackPresent(this.reqs)) {
            ...
            if (!hasConfirmationCallback(reqs) && !isPollingCallbackPresent(reqs)) {
                requirements.callbacks.push({
                    "input": {
                        index: requirements.callbacks.length,
                        name: "loginButton",
            ...
            } else if (!this.pollingInProgress || !isPollingCallbackPresent(reqs)) {
