        ...
        describe("#removeUnrequiredNonDefaultProperties", () => {
            ...
            beforeEach(() => {
                const jsonSchema = new JSONSchema({
                    ...
                    "defaultProperties" : ["requiredDefault", "unrequiredDefault"]
                });
                schema = jsonSchema.removeUnrequiredNonDefaultProperties();
            });
            it("removes properties where \"required\" is \"false\"", () => {
                expect(schema.raw.properties)
                    .to.have.keys(["requiredNonDefault", "requiredDefault", "unrequiredDefault"]);
                expect(schema.raw.properties).not.to.have.keys("unrequiredNonDefault");
            });
        });
