    ...
    describe("org/forgerock/openam/ui/common/models/JSONValues", () => {
        ...
        describe("#revertFalseCollections", () => {
            it("reverts false collection properties back into field properties (OPENAM-10769)", () => {
                ...
                expect(values.raw.defaults).to.contain.keys("defaultsObject");
                expect(values.raw).to.not.have.keys("defaultsObject");
                expect(values.raw._defaultsCollectionProperties).to.eql(["defaultsCollection"]);
