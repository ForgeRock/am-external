...
define([
    "lodash",
    "store/modules/local/authentication/trees/list"
], ({ omit }, module) => {
    const treeOne = { _id: "one", nodes: {} };
    const treeTwo = { _id: "two", nodes: {} };

    describe("store/modules/local/authentication/trees/list", () => {
        describe("actions", () => {
            describe("#addOrUpdate", () => {
                it("creates an action", () => {
                    expect(module.addOrUpdate(treeOne)).eql({
                        type: "local/authentication/trees/list/ADD_OR_UPDATE",
                        payload: treeOne
                    });
                });
            });
            describe("#remove", () => {
                it("creates an action", () => {
                    expect(module.remove("one")).eql({
                        type: "local/authentication/trees/list/REMOVE",
                        payload: "one"
                    });
                });
            });
            describe("#set", () => {
                it("creates an action", () => {
                    expect(module.set([treeOne, treeTwo])).eql({
                        type: "local/authentication/trees/list/SET",
