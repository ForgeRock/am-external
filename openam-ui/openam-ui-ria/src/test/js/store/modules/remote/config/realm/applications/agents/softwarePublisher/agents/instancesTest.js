...
define([
    "store/modules/remote/config/realm/applications/agents/softwarePublisher/agents/instances"
], (module) => {
    const agentOne = { _id: "one" };
    const agentTwo = { _id: "two" };

    describe("store/modules/remote/config/realm/applications/agents/softwarePublisher/agents/instances", () => {
        describe("actions", () => {
            const typePrefix = "remote/config/realm/applications/agents/softwarePublisher/agents/instances/";

            describe("#addInstance", () => {
                it("creates an action", () => {
                    expect(module.addInstance(agentOne)).eql({
                        type: `${typePrefix}ADD_INSTANCE`,
                        payload: agentOne
                    });
                });
            });
