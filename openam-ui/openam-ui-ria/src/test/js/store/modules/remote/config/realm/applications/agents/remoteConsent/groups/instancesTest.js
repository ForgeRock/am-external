...
define([
    "store/modules/remote/config/realm/applications/agents/remoteConsent/groups/instances"
], (module) => {
    const groupOne = { _id: "one" };
    const groupTwo = { _id: "two" };

    describe("store/modules/remote/config/realm/applications/agents/remoteConsent/groups/instances", () => {
        describe("actions", () => {
            describe("#addInstance", () => {
                it("creates an action", () => {
                    expect(module.addInstance(groupOne)).eql({
                        type: "remote/config/realm/applications/agents/remoteConsent/groups/instances/ADD_INSTANCE",
                        payload: groupOne
                    });
                });
            });
            describe("#setInstances", () => {
                it("creates an action", () => {
                    expect(module.setInstances([groupOne, groupTwo])).eql({
                        type: "remote/config/realm/applications/agents/remoteConsent/groups/instances/SET_INSTANCES",
