...
define([
    "store/modules/remote/config/realm/applications/agents/soapSts/agents/instances"
], (module) => {
    const agentOne = { _id: "one" };
    const agentTwo = { _id: "two" };

    describe("store/modules/remote/config/realm/applications/agents/soapSts/agents/instances", () => {
        describe("actions", () => {
            describe("#addInstance", () => {
                it("creates an action", () => {
                    expect(module.addInstance(agentOne)).eql({
                        type: "remote/config/realm/applications/agents/soapSts/agents/instances/ADD_INSTANCE",
                        payload: agentOne
                    });
                });
            });
            describe("#setInstances", () => {
                it("creates an action", () => {
                    expect(module.setInstances([agentOne, agentTwo])).eql({
                        type: "remote/config/realm/applications/agents/soapSts/agents/instances/SET_INSTANCES",
