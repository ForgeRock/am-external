...
describe("store/modules/local/config/global/secretStores/types/selected", () => {
    ...
    describe("actions", () => {
        describe("#reset", () => {
            it("creates an action", () => {
                expect(reset()).eql({
                    type: "local/config/global/secretStores/types/selected/RESET"
                });
            });
        });
        ...
        describe("#set", () => {
            it("creates an action", () => {
                expect(set(selectedType)).eql({
                    ...
                    type: "local/config/global/secretStores/types/selected/SET"
                });
            });
        });
    });
