...
describe("store/modules/remote/config/realm/applications/agents/trustedJwtIssuer/agents/instances", () => {
    describe("actions", () => {
        const typePrefix = "remote/config/realm/applications/agents/trustedJwtIssuer/agents/instances/";
