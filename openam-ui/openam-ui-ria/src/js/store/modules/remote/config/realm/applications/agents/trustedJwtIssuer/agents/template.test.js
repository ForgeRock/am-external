...
describe("store/modules/remote/config/realm/applications/agents/trustedJwtIssuer/agents/template", () => {
    describe("actions", () => {
        describe("#setTemplate", () => {
            it("creates an action", () => {
                expect(setTemplate(template)).eql({
                    type: "remote/config/realm/applications/agents/trustedJwtIssuer/agents/template/SET_TEMPLATE",
                    payload: template
                });
            });
        });
