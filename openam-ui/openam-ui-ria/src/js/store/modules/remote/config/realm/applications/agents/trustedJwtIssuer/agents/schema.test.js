...
describe("store/modules/remote/config/realm/applications/agents/trustedJwtIssuer/agents/schema", () => {
    describe("actions", () => {
        describe("#setSchema", () => {
            it("creates an action", () => {
                expect(setSchema(schema)).eql({
                    type: "remote/config/realm/applications/agents/trustedJwtIssuer/agents/schema/SET_SCHEMA",
                    payload: schema
                });
            });
        });
