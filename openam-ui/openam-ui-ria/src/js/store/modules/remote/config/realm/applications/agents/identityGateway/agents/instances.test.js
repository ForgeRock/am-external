...
describe("store/modules/remote/config/realm/applications/agents/identityGateway/agents/instances", () => {
    describe("actions", () => {
        describe("#addInstance", () => {
            it("creates an action", () => {
                expect(addInstance(agentOne)).eql({
                    type: "remote/config/realm/applications/agents/identityGateway/agents/instances/ADD_INSTANCE",
                    payload: agentOne
                });
            });
        });
        describe("#setInstances", () => {
            it("creates an action", () => {
                expect(setInstances([agentOne, agentTwo])).eql({
                    type: "remote/config/realm/applications/agents/identityGateway/agents/instances/SET_INSTANCES",
