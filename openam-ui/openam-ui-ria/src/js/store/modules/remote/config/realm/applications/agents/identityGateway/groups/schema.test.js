...
describe("store/modules/remote/config/realm/applications/agents/identityGateway/groups/schema", () => {
    describe("actions", () => {
        describe("#setSchema", () => {
            it("creates an action", () => {
                expect(setSchema(schema)).eql({
                    type: "remote/config/realm/applications/agents/identityGateway/groups/schema/SET_SCHEMA",
                    payload: schema
                });
            });
        });
