...
describe("store/modules/remote/config/realm/applications/agents/identityGateway/agents/template", () => {
    describe("actions", () => {
        describe("#setTemplate", () => {
            it("creates an action", () => {
                expect(setTemplate(template)).eql({
                    type: "remote/config/realm/applications/agents/identityGateway/agents/template/SET_TEMPLATE",
                    payload: template
                });
            });
        });
