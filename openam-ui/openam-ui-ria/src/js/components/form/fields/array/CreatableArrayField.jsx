...
import CreatableArrayInput from "components/form/inputs/array/CreatableArrayInput";

const CreatableArrayField = ({ autofocus, formData, idSchema, ...restProps }) => (
    <CreatableArrayInput
        /**
