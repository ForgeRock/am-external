...
import EditTrustedJwtIssuerAgentGroupTemplate from "templates/admin/views/realms/applications/agents/trusted-jwt-issuer/groups/edit/EditTrustedJwtIssuerAgentGroupTemplate"; // eslint-disable-line max-len

class EditTrustedJwtIssuerAgentGroup extends AbstractView {
    constructor () {
        super();
        this.template = EditTrustedJwtIssuerAgentGroupTemplate;
        this.events = {
    ...
    render ([realm, id]) {
        ...
        Promise.all([
            ...
            get(realm, TRUSTED_JWT_ISSUER, id)
        ]).then(([schema, values]) => {
            return {
...
export default EditTrustedJwtIssuerAgentGroup;
