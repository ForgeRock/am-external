...
import NewIdentityGatewayAgentGroupForm from "./NewIdentityGatewayAgentGroupForm";
import PageHeader from "components/PageHeader";
import Router from "org/forgerock/commons/ui/common/main/Router";

class NewIdentityGatewayAgentGroup extends Component {
    constructor (props) {
        super(props);
    ...
    render () {
        ...
        if (this.props.isFetching) {
            ...
            content = (
                <NewIdentityGatewayAgentGroupForm
        ...
        return (
            <div>
                <PageHeader title={ t("console.applications.agents.identityGateway.groups.new.title") } />
                <Panel>
                    <Panel.Body>{ content }</Panel.Body>
                    <Panel.Footer>
                        <CreateFooter
                            backRoute={ Router.configuration.routes.realmsApplicationsAgentsIdentityGateway }
...
NewIdentityGatewayAgentGroup.propTypes = {
...
export default NewIdentityGatewayAgentGroup;
