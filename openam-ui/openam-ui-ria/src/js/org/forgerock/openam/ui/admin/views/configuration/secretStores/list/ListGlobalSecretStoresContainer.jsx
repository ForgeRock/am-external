...
import { getAll, getCreatableTypes, getSingletonTypes, remove }
...
import { remove as removeInstance, set as setInstances, withCompositeId }
    from "store/modules/remote/config/global/secretStores/instances/list";
import { set as setSingletonStoreTypes }
    from "store/modules/remote/config/global/secretStores/singletons/types/list";
...
class ListGlobalSecretStoresContainer extends Component {
    ...
    handleDelete (selectedItems) {
        ...
        showConfirmationBeforeAction({ message: confirmMessage }, async () => {
            try {
