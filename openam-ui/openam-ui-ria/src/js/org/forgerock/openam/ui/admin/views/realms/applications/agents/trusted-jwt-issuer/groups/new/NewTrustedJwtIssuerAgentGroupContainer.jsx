...
import { setSchema } from "store/modules/remote/config/realm/applications/agents/trustedJwtIssuer/groups/schema";
import { setTemplate } from "store/modules/remote/config/realm/applications/agents/trustedJwtIssuer/groups/template";
...
NewTrustedJwtIssuerAgentGroupContainer = connectWithStore(NewTrustedJwtIssuerAgentGroupContainer,
    (state) => ({
        schema: state.remote.config.realm.applications.agents.trustedJwtIssuer.groups.schema,
        template: state.remote.config.realm.applications.agents.trustedJwtIssuer.groups.template
    }),
    (dispatch) => ({
