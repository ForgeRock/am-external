...
class NewSoapSTSAgentGroup extends Component {
    constructor (props) {
        super(props);
        this.state = {
            groupId: ""
    ...
    render () {
        ...
        return (
            <div>
                <PageHeader title={ t("console.applications.agents.soapSts.groups.new.title") } />
                <Panel>
                    <Panel.Body>{ content }</Panel.Body>
                    <Panel.Footer>
                        <CreateFooter
                            backRoute={ Router.configuration.routes.realmsApplicationsAgentsSoapSTS }
...
NewSoapSTSAgentGroup.propTypes = {
...
export default NewSoapSTSAgentGroup;
