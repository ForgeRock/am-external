...
class NewTrustedJwtIssuerAgent extends Component {
    constructor (props) {
        super(props);
        this.state = {
            agentId: ""
    ...
    render () {
        ...
        return (
            <div>
                <PageHeader title={ t("console.applications.agents.trustedJwtIssuer.agents.new.title") } />
                <Panel>
...
NewTrustedJwtIssuerAgent.propTypes = {
...
export default NewTrustedJwtIssuerAgent;
